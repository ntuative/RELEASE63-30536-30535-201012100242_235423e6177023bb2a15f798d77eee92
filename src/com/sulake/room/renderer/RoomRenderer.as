   ...
   public class RoomRenderer implements IRoomRenderer, IRoomSpriteCanvasContainer
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_142 != null)
         {
            ...
            {
               _loc2_ = this.var_142.getWithIndex(_loc1_) as RoomSpriteCanvas;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function removeRoomObject(param1:int) : void
      {
         ...
         {
            _loc4_ = this.var_142.getWithIndex(_loc3_) as RoomSpriteCanvas;
            if(_loc4_ != null)
            {
      ...
      public function render() : void
      {
         ...
         ErrorReportStorage.addDebugData("Canvas count","Canvas count: " + this.var_142.length);
         var _loc2_:int = this.var_142.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_142.getWithIndex(_loc2_) as IRoomRenderingCanvas;
            if(_loc3_ != null)
            {
      ...
      {
         var _loc6_:* = null;
         var _loc5_:IRoomRenderingCanvas = this.var_142.getValue(String(param1)) as IRoomRenderingCanvas;
         if(_loc5_ != null)
         {
         ...
         this.var_142.add(String(param1),_loc5_);
         return _loc5_;
      }
      
      public function getCanvas(param1:int) : IRoomRenderingCanvas
      {
         return this.var_142.getValue(String(param1)) as IRoomRenderingCanvas;
      }
      
      public function disposeCanvas(param1:int) : Boolean
      {
         var _loc2_:RoomSpriteCanvas = this.var_142.remove(String(param1)) as RoomSpriteCanvas;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
         }
      ...
      public function update(param1:uint) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_142.getWithIndex(_loc2_) as RoomSpriteCanvas;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
