package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_1216:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_1996:Number = -1.0E7;
      
      private var var_1995:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_223.addChild(this.var_52);
         ...
         this.var_530 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_431.x -= param1 - this.var_528;
         this.var_528 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_431.y -= param1 - this.var_529;
         this.var_529 = param1;
      }
      ...
      {
         if(param1 && !this.var_869)
         {
            this.var_869 = true;
            if(this.var_115 != null && !this.var_223.contains(this.var_115))
            {
               this.var_223.addChild(this.var_115);
               this.var_52.mask = this.var_115;
            }
         }
         else if(!param1 && this.var_869)
         {
            this.var_869 = false;
            if(this.var_115 != null && this.var_223.contains(this.var_115))
            {
               this.var_223.removeChild(this.var_115);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_531.length)
            {
               this.cleanSprite(this.var_531[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            this.var_531 = [];
         }
      ...
      {
         this.var_530.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_647 != this.var_1997 || this._ht != this.var_1994)
         {
            _loc9_ = true;
         }
         if(this.var_52.x != this.var_528 || this.var_52.y != this.var_529)
         {
            this.var_52.x = this.var_528;
            this.var_52.y = this.var_529;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_1997 = this.var_647;
         this.var_1994 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_530.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_530.getObjectCache(param2);
         ...
         while(_loc21_ < _loc12_)
         {
            ...
            if(_loc18_ != null && _loc18_.visible)
            {
               ...
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_528;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_529;
                  if(_loc19_ < this.var_647 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     ...
                     _loc17_.x = _loc19_ - this.var_528;
                     _loc17_.y = _loc20_ - this.var_529;
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         {
            _loc3_ = this.var_531.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(param1 < this.var_648 || this.var_648 == 0)
         {
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(this.var_971 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1485;
         }
         this.var_1485 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_971;
         return this.var_1485;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_647 / 2;
         var _loc12_:Number = param2 - this._ht / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1486,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_532.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_532.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_1996 || param2 != this.var_1995)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_532.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_532.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         ...
         {
            this.var_296.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_296 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_296.getKey(_loc1_);
            _loc3_ = this.var_296.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1216.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
                     _loc5_ = _loc4_.method_5();
                     if(_loc5_ != null)
                     {
