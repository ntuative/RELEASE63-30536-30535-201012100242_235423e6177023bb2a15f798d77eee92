   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_176 != null)
         {
            ...
            {
               _loc1_ = this.var_176[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(this.var_176.length > param1)
         {
            _loc2_ = this.var_176[this.var_176.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         if(param1 >= 0 && param1 < this.var_176.length)
         {
