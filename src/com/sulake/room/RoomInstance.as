   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_221 != null)
         {
            ...
            {
               _loc3_ = this.var_221.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function update() : void
      {
         ...
         var _loc2_:int = this.var_516.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = int(this.var_516[_loc2_]);
      ...
      {
         return this.var_221.getKeys();
      }
      
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         var _loc2_:String = String(param1);
         if(this.var_221.getValue(_loc2_) != null)
         {
            return this.var_221.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
         ...
         if(_loc3_ != null)
         {
            this.var_221.add(_loc2_,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         return this.var_221.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_221.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_221.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
