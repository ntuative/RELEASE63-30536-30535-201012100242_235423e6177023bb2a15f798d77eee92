package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2675:IRoomContentLoader;
      
      private var var_566:IRoomObjectFactory = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_567 = [];
         this.var_516 = [];
         events.addEventListener(RoomContentLoadedEvent.const_324,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_414,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_692,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_566 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_566 == null || this.var_453 == null)
         {
            return;
         }
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_567.indexOf(_loc5_) < 0)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_516.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_516[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_566.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_566 != null)
         {
            return this.var_566.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_591)
         {
            return;
         }
         if(this.var_45 == null)
         {
            this._state = const_591;
            return;
         }
         if(this.var_45.getGraphicAssetCollection(param1) != null)
         {
                        ...
                        if(_loc16_ == param1)
                        {
                           ...
                           if(_loc19_ != null)
                           {
                              ...
                              else
                              {
                                 ...
                                 _loc20_ = this.var_566.createRoomObjectLogic(_loc18_);
