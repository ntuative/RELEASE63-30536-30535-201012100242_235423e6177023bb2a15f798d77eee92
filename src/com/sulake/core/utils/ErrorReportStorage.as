package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_714:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         ...
         while(_loc2_ < var_714.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_714.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_714.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         return var_1078[param1];
      }
      
      public static function getParameterNames() : Array
      {
         return var_1078.getKeys();
      }
   }
}
