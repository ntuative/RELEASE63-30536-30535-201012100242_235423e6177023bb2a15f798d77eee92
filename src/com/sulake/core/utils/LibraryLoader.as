package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1521:uint = 1;
      
      protected static const const_1523:uint = 2;
      
      protected static const const_1524:uint = 4;
      ...
      private static var var_675:Array = new Array();
      ...
      protected var var_695:XML;
      
      protected var var_576:Class;
      ...
      protected var var_2683:uint = 0;
      
      protected var var_2599:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1059)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_675[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_675.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_675.length < const_1441 && false)
            {
               _loc1_ = var_829.shift() as LibraryLoader;
      ...
      {
         return !!this.var_929 ? uint(this.var_1156 - this.var_1866) : uint(getTimer() - this.var_1866);
      }
      ...
      {
         if(this.var_928 && !_disposed)
         {
            this.var_928 = false;
            if(!this.var_929 && this.var_215)
            {
               this.var_1156 = -1;
      ...
      {
         if(!this.var_929 && !_disposed && this.var_1155 > 0)
         {
            try
            {
               this.var_36.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_215,const_1381 - this.var_1155);
            if(this.var_2599)
            {
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_409 = LibraryLoader.name_2;
         ...
         if(this.var_409 == LibraryLoader.const_1522)
         {
         ...
         if(this.var_409 == LibraryLoader.name_2)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_576 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_576.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_695 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
