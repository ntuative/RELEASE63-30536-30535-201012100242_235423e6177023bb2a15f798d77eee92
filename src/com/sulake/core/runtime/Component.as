package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      private var var_482:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_482 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_482.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_482.getStructByInterface(param1);
         if(_loc2_ == null)
         {
            this.var_1165 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(this.var_1165);
         }
         var _loc3_:uint = _loc2_.release();
         if(this.var_1410 & const_892)
         {
            if(_loc3_ == 0)
            {
               if(this.var_482.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_638 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_482.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_482.getStructByIndex(_loc8_);
