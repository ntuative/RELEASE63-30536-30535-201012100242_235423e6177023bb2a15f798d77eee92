package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1060:uint = 0;
      ...
      protected static const const_1533:String = "_IGNORE_INHERITED_STYLE";
      ...
      protected var var_761:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_642 = _loc13_.blend;
            var_415 = _loc13_.treshold;
            if(var_414 != _loc13_.background)
            {
      ...
      {
         return this.var_761 != null ? this.var_761 : (this.var_13 != null ? this.var_13.procedure : this.nullEventProc);
      }
      ...
      {
         var_414 = param1;
         var_217 = !!var_414 ? uint(var_217 | var_509) : uint(var_217 & 16777215);
      ...
      {
         var_509 = param1 & 4278190080;
         var_217 = !!var_414 ? uint(param1) : uint(param1 & 16777215);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      ...
      {
         var_509 = param1 << 24;
         var_217 = !!var_414 ? uint(var_509 | var_217) : uint(16777215 & var_217);
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_71);
      }
      
      public function set blend(param1:Number) : void
      {
         var_642 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_16.invalidate(this,var_11,WindowRedrawFlag.const_1106);
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_79 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_506,this,null));
         }
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this.var_13 != param1)
         {
            ...
            if(this.var_13 != null)
            {
               this.var_325 = this.var_13.rectangle.clone();
               var_56.x = var_11.x;
               var_56.y = var_11.y;
               var_56.width = var_11.width;
               var_56.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_423,this,this.var_13));
            }
            else
            {
               this.var_325.x = 0;
               ...
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_1028,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_667,var_11);
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_20,var_16,var_11,null,this.var_761,this.properties,var_760.concat(),_id) as WindowController;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2323 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_501)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            ...
            else if(_loc7_ == WindowParam.const_518)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_1004,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_804,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = 0;
         if(!testParamFlag(WindowParam.const_682))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_38:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_905;
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_165:
                  ...
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_517,this,null));
                     if(testParamFlag(WindowParam.const_185,WindowParam.const_147))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_169,WindowParam.const_157))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this.var_13 != null)
               ...
               case WindowNotifyEvent.const_424:
                  var_16.invalidate(this,var_11.union(var_56),WindowRedrawFlag.const_522);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_1080,this,null));
                     if(this.var_13 != null)
                     {
                        this.var_13.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_299,this.var_13,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_348:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_625,this,null));
                     if(this.var_13 != null)
                     {
               ...
               case WindowNotifyEvent.const_539:
                  var_16.invalidate(this,var_11,WindowRedrawFlag.const_1039);
                  break;
               case WindowNotifyEvent.const_506:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1533) == -1)
                     {
                        _loc8_.style = var_79;
                     }
                  }
               ...
               case WindowNotifyEvent.const_517:
                  this.var_13.getRegionProperties(null,this.var_325);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1336:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1455:
               _loc2_ = "null";
               break;
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_128,WindowParam.const_147);
         var _loc2_:* = !testParamFlag(WindowParam.const_123,WindowParam.const_157);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this.var_13.width - this.var_325.width;
            ...
            if(_loc2_)
            {
               _loc4_ = this.var_13.height - this.var_325.height;
               _loc5_ = uint(var_20 & 0);
      ...
      {
         if(_state == WindowState.const_431)
         {
            return true;
         }
         _state = WindowState.const_431;
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1325 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_332,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1325 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_811,this,param1));
         return param1;
      }
