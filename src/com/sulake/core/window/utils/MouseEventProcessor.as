      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_615.x || _loc3_.stageY != this.var_615.y)
            {
               ...
               _loc6_ = new Array();
               this.var_129.groupParameterFilteredChildrenUnderPoint(this.var_615,_loc6_,WindowParam.const_28);
            }
