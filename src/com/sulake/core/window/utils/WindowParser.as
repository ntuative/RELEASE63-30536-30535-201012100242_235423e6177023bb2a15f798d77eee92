package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1082:String = "_EXCLUDE";
      
      public static const const_1791:String = "_INCLUDE";
      
      public static const const_1673:String = "_TEMP";
      
      private static const const_1141:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_924:Dictionary;
      
      protected var var_1406:Dictionary;
      
      protected var var_1861:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1151);
         this.var_924 = new Dictionary();
         this.var_1406 = new Dictionary();
         ParamCodeTable.fillTables(this.var_924,this.var_1406);
         this.var_1861 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1142,"");
         return param1.replace(const_1141,"");
      }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1151[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1082) == -1)
                  {
