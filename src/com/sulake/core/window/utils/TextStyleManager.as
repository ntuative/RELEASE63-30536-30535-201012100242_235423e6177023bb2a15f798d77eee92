package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_340:String = "regular";
      ...
      private static const const_1210:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_83[const_340],var_83[ITALIC],var_83[BOLD]];
            var_83.reset();
            var_83[const_340] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         for each(_loc5_ in _loc4_)
         {
            ...
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1210) + 2,_loc5_.length);
            }
