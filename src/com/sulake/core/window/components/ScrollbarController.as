package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1184:String = "increment";
      
      private static const const_1185:String = "decrement";
      ...
      protected var var_616:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_473,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_44,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_473,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_809 = _loc3_.value as String;
            }
            _loc4_++;
         }
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_304)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_616;
                  }
                  else
                  {
                     this.scrollV -= this.var_616;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_38 || param1.type == WindowTouchEvent.const_447)
         {
            ...
            else if(param2.name == const_1185)
            {
               if(this.var_19)
               {
                  this.var_997 = true;
      ...
      private function method_4() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_809) as IScrollableWindow;
            if(_loc1_ == null && var_13 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_13).findChildByName(this.var_809) as IScrollableWindow;
               if(_loc1_)
               {
