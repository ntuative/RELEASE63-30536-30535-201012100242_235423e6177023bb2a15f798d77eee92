package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected static const const_1122:String = "spacing";
      
      protected static const const_1123:String = "scale_to_fit_items";
      
      protected static const const_1125:String = "resize_on_item_update";
      ...
      protected var var_930:Boolean = true;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_150 = var_414 || !testParamFlag(WindowParam.const_31);
         this._container = var_16.create("_CONTAINER","",WindowType.const_380,WindowStyle.const_783,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         ...
         this._container.addEventListener(WindowEvent.const_483,this.containerEventHandler);
      ...
      {
         return new Rectangle(this.var_617 * this.maxScrollH,this.var_618 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_617 = param1;
            this._container.x = -this.var_617 * this.maxScrollH;
            var_16.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_71);
            dispatchEvent(new WindowEvent(WindowEvent.const_473,this,null));
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_483,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_172:
               if(this.var_1160)
               {
                  this.var_1162 = this.var_1877 - _loc3_;
                  this.var_1163 = this.var_1876 - _loc4_;
                  if(this._horizontal)
                  {
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_930 && !this.var_508 && this._container)
         {
            this.var_508 = true;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1122,this._spacing,PropertyStruct.const_53,this._spacing != DEF_SPACING));
         _loc1_.push(new PropertyStruct(const_1124,this.var_930,PropertyStruct.const_50,this.var_930 != const_1530));
         _loc1_.push(new PropertyStruct(const_1123,this.var_507,PropertyStruct.const_50,this.var_507 != const_1531));
         _loc1_.push(new PropertyStruct(const_1125,this.var_1161,PropertyStruct.const_50,this.var_1161 != DEF_RESIZE_ON_ITEM_UPDATE));
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case const_1125:
                  ...
                  break;
               case const_1124:
                  this.var_930 = _loc2_.value as Boolean;
                  break;
            }
         }
