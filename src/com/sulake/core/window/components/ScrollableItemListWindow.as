package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      override public function dispose() : void
      {
         if(this.var_399)
         {
            this.var_399.removeEventListener(WindowEvent.const_308,this.scrollBarEventProc);
            this.var_399.removeEventListener(WindowEvent.const_210,this.scrollBarEventProc);
            this.var_399 = null;
         }
         if(this.var_1116)
         {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_399)
         {
            this.var_399 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_399)
            {
               this.var_399.addEventListener(WindowEvent.const_308,this.scrollBarEventProc);
               this.var_399.addEventListener(WindowEvent.const_210,this.scrollBarEventProc);
            }
         }
         return this.var_399;
      }
      ...
      public function set method_12(param1:Boolean) : void
      {
