package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_1117:String = "_DROPMENU_ITEMLIST";
      
      protected static const const_1116:String = "item_array";
      ...
      public function set selection(param1:int) : void
      {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_540 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_374,this,null));
         }
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_155 == null || this.var_155.disposed)
         {
            this.var_155 = context.create(name + "::submenu","",WindowType.const_457,var_79,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
      ...
      {
         var _loc2_:int = -1;
         var _loc3_:IItemListWindow = getChildByName(DropMenuController.const_1117) as IItemListWindow;
         if(_loc3_ != null)
         {
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_793 = false;
            this.getTitleText().text = this.var_540 < this._itemArray.length && this.var_540 > -1 ? this._itemArray[this.var_540] : caption;
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IItemListWindow = param2.getChildByName(DropMenuController.const_1117) as IItemListWindow;
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_486,var_79,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_380,var_79,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_540 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_540).setStateFlag(WindowState.const_49,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_38 || param1.type == WindowTouchEvent.const_447)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1027:
            case WindowMouseEvent.const_56:
               ...
               break;
            case WindowTouchEvent.const_757:
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_1116,this._itemArray,PropertyStruct.const_145,this._itemArray.length > 0));
         return _loc1_;
      }
