package com.sulake.core.window.components
{
   ...
   public class TabButtonController extends SelectableController implements ITabButtonWindow
   {
      ...
      private static const const_1535:String = "TAB_BUTTON_CONTENT";
      
      private static const const_1133:String = "TAB_BUTTON_TITLE";
      
      private static const const_1534:String = "TAB_BUTTON_ICON";
      ...
      override public function set caption(param1:String) : void
      {
         ...
         var _loc2_:ITextWindow = ITextWindow(findChildByTag(const_1133));
         if(_loc2_ != null)
         {
            _loc2_.text = param1;
         }
