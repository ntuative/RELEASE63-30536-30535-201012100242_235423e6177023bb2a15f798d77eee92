package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1162:String = "_TITLE";
      
      private static const const_1163:String = "_HEADER";
      ...
      private static const const_838:String = "margin_right";
      ...
      private var var_1214:IHeaderWindow;
      ...
      public function get title() : ITextWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1162) as ITextWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1214 = findChildByTag(const_1163) as IHeaderWindow;
            if(!this.var_1214)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_159 = findChildByTag(const_1165) as IWindowContainer;
            if(!this.var_159)
            {
      ...
      {
         return this.content != null && this.var_929 ? this.content.iterator : new Iterator(this);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(const_839,_loc3_.left,PropertyStruct.const_53,_loc2_));
         _loc1_.push(new PropertyStruct(const_836,_loc3_.top,PropertyStruct.const_53,_loc2_));
         _loc1_.push(new PropertyStruct(const_838,0 - _loc3_.right,PropertyStruct.const_53,_loc2_));
         _loc1_.push(new PropertyStruct(const_837,0 - _loc3_.bottom,PropertyStruct.const_53,_loc2_));
         return _loc1_;
      }
