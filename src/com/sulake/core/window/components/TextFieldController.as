package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1171 = param1 == null ? "" : param1;
      }
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_924,var_11);
         }
         return var_21;
      }
      ...
      {
         if(param1.type == WindowTouchEvent.const_447)
         {
            this.focus();
         }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_639 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("focus_capturer",this.var_1167,PropertyStruct.const_50,this.var_1167 != false));
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_1167 = _loc2_.value as Boolean;
               if(this.var_1167)
               {
