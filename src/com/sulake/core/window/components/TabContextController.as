package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1136:String = "_SELECTOR";
      
      private static const const_1137:String = "_CONTENT";
       
      
      protected var var_923:ITabSelectorWindow;
      
      protected var var_1860:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_923 = findChildByTag(const_1136) as ITabSelectorWindow;
            if(this.var_923 != null)
            {
               this.var_923.procedure = this.selectorEventProc;
            }
         }
         return this.var_923;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1860 = findChildByTag(const_1137) as IWindowContainer;
         }
      ...
      {
         return !!this.var_639 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_923.numSelectables;
      }
