package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1316:uint = 0;
      
      public static const const_667:uint = 1;
      
      public static const const_924:uint = 2;
      
      public static const const_621:uint = 4;
      
      public static const const_1327:uint = 8;
      
      public static const const_1293:uint = 16;
      
      public static const const_1738:uint = 64;
      
      public static const const_1762:uint = 128;
      
      public static const const_1014:uint = 256;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_924:
               ...
               break;
            case GraphicContext.const_1327:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1293:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_621:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1014:
               break;
            case GraphicContext.const_1316:
               break;
            default:
         ...
         if(this.var_758)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1867,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1867,16777215);
                  }
                  var_290 += bitmap.width * bitmap.height * 4;
               }
