package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_832:uint = 8;
      
      private static const const_1146:String = "skin";
      
      private static const const_1150:String = "bitmap";
      
      private static const const_1149:String = "fill";
      
      private static const const_1148:String = "text";
      
      private static const const_1145:String = "shape";
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_771 = new Dictionary();
         this.var_770 = new Dictionary();
         this.var_1437 = new Dictionary();
         this.var_1916 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1437,this.var_1916);
         this.var_1914 = new Dictionary();
         this.var_1915 = new Dictionary();
         StateCodeTable.fillTables(this.var_1914,this.var_1915);
         this.var_418 = new Dictionary();
         this.var_418[const_1146] = BitmapSkinRenderer;
         this.var_418[const_1150] = BitmapDataRenderer;
         this.var_418[const_1149] = FillSkinRenderer;
         this.var_418[const_1148] = TextSkinRenderer;
         this.var_418[const_1145] = ShapeSkinRenderer;
         this.var_418[const_1151] = SkinRenderer;
         this.var_418[const_1147] = NullSkinRenderer;
         if(var_289 == null)
         {
            var_289 = new Array();
            var_289.push(WindowState.const_63);
            var_289.push(WindowState.const_72);
            var_289.push(WindowState.const_84);
            var_289.push(WindowState.const_49);
            var_289.push(WindowState.WINDOW_STATE_HOVERING);
            var_289.push(WindowState.const_79);
            var_289.push(WindowState.const_100);
            var_289.push(WindowState.const_90);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1437[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_771[param1] == null)
         {
            this.var_771[param1] = new Array(const_832);
         }
         this.var_771[param1][param2] = param3;
         if(this.var_770[param1] == null)
         {
            this.var_770[param1] = new Array(const_832);
         }
         this.var_770[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_771[param1];
         if(_loc3_)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_770[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_266)
