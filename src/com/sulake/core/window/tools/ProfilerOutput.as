package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_134)
         {
            this.var_134.removeStopEventListener(this.refresh);
            this.var_134 = null;
         }
         if(!this.var_134 && param1)
         {
            this.var_134 = param1;
            this.var_134.addStopEventListener(this.refresh);
         }
      }
      ...
      {
         var _loc2_:Array = this.var_134.getProfilerAgentsInArray();
         ...
         if(this.var_1520)
         {
            ITextWindow(this._window.findChildByName("footer")).text = "Assets - Libraries: " + this.var_134.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_134.numBitmapAssetInstances + " / " + this.var_134.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_134.numTrackedBitmapDataInstances + " / " + this.var_134.numTrackedBitmapDataBytes + " bytes";
         }
      }
