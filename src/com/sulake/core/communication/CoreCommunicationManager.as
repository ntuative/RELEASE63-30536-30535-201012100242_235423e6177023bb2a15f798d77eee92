package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1698:IConnectionStateListener;
      ...
      override public function dispose() : void
      {
         ...
         this.var_864 = null;
         for each(_loc3_ in this.var_1333)
         {
         }
         var _loc5_:* = null;
         this.var_1064 = null;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1052:
               _loc3_ = new SocketConnection(param1,this,this.var_1698);
               break;
            default:
      ...
      {
         var _loc2_:Class = this.var_1064[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc3_:Array = this.var_864[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = this.var_864[_loc3_];
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1333)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
