package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_927 = new LoaderContext();
         this.var_927.checkPolicyFile = true;
         ...
         {
            this.var_36.load(param2,this.var_927);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_288 = 0;
         this.var_36.load(param1,this.var_927);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_288 < var_2601)
            {
               ...
               this.var_36.load(new URLRequest(this.var_926 + (this.var_926.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_288),this.var_927);
               return true;
            }
         }
         return false;
