   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_102 is BitmapDataAsset)
         {
            ...
            this.var_1221 = BitmapDataAsset(this.var_102).var_1221;
            this.var_1222 = BitmapDataAsset(this.var_102).var_1222;
            if(this._bitmap != null)
            {
               this.var_102 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1221 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1222 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
