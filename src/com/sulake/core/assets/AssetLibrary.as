package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1075:String = "AssetLibraryReady";
      
      public static const const_715:String = "AssetLibraryLoaded";
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_852.splice(var_852.indexOf(this),1);
            --var_466;
            this.var_465 = null;
            this.var_854 = null;
            this.var_140 = null;
      ...
      {
         if(this._file == param1.url && this.var_855)
         {
            if(!this.var_853 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_695,this.var_576);
            }
            this.var_853 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1075));
         }
         else
         {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in this.var_465)
         {
            _loc2_ = this.var_465[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_465[_loc1_];
         }
      ...
      {
         var _loc2_:Class = this.var_854[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_465[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_952,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_910,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_995,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_465[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_465[loader.url];
         if(struct == null)
         {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_465[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return this.var_140[param1] != null || (this.var_576 != null ? this.var_576[param1] != null : false);
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_695 = _loc2_.manifest.copy();
         this.var_576 = _loc2_.resource;
         ...
         this.var_855 = true;
         dispatchEvent(new Event(AssetLibrary.const_715));
         dispatchEvent(new Event(AssetLibrary.const_1075));
         if(this.var_853)
         {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_695.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_576[param1]);
