package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      private function onUserInfo(param1:ModeratorUserInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_954)
         {
      ...
      private function onRoomInfo(param1:ModeratorRoomInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_955)
         {
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         this.onChatlog("Call For Help Chatlog: " + _loc2_.data.chatRecordId,WindowTracker.const_980,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         this.onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_620,_loc2_.data.roomId,_loc3_,_loc4_);
      }
      ...
      {
         var _loc6_:* = null;
         for each(_loc6_ in this.var_953)
         {
      ...
      private function onRoomVisits(param1:RoomVisitsEvent) : void
      {
         ...
         for each(_loc3_ in this.var_956)
         {
      ...
      private function onRoomEnter(param1:RoomEntryInfoMessageEvent) : void
      {
         ...
         for each(_loc3_ in this.var_776)
         {
            _loc3_.onRoomChange();
         }
      }
      ...
      public function removeChatlogListener(param1:ChatlogCtrl) : void
      {
         var _loc3_:* = null;
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_953)
         {
            if(_loc3_ != param1)
            {
               _loc2_.push(_loc3_);
