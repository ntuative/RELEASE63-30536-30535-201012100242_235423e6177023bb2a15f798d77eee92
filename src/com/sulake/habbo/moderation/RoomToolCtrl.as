package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1269:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_44.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_314));
         Logger.log("BEGINNING TO SHOW: " + this.var_314);
      }
      ...
      {
         Logger.log("GOT ROOM INFO: " + param1.flatId + ", " + this.var_314);
         if(param1.flatId != this.var_314)
         {
            Logger.log("NOT THE SAME FLAT: " + param1.flatId + ", " + this.var_314);
            return;
         }
         this._data = param1;
         this.populate();
      ...
      public function populate() : void
      {
         ...
         this.var_831 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1270 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1269 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_44,WindowTracker.const_620,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_551 || this.var_424.text == "")
         {
            this.var_44.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_831.isSelected);
         this.var_44.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1274,_loc2_,this.var_424.text,"",""));
         if(this.var_1270.isSelected || this.var_1269.isSelected || this.var_831.isSelected)
         {
            this.var_44.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1270.isSelected,this.var_1269.isSelected,this.var_831.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1258);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_44.initMsg.roomMessageTemplates[this.var_1006.selection];
         if(_loc3_ != null)
         {
            this.var_551 = false;
