package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1748 ? 0 : 1,this._roomId),this.var_44,WindowTracker.const_620,this._roomId),this._frame,false,false,true);
      }
