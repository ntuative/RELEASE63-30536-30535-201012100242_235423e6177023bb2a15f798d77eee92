package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1045:String = "issue_bundle_open";
      
      public static const const_801:String = "issue_bundle_my";
      ...
      private var var_523:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_523 = new IssueBrowser(this,this.var_60.windowManager,this.var_60.assets);
         this.var_958 = [];
         this.var_959 = [];
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_958 = this.var_958.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_158 && (_loc4_ == null || _loc5_.getPrioritySum() > _loc4_.getPrioritySum()))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_334 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_959 = this.var_959.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_523 == null || !this.var_523.isOpen())
         {
            this.var_60.soundManager.playSound(HabboSoundTypesEnum.const_921);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_779.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_779.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         ...
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_93)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_779.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_1980++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_779.add(param1.issueId,_loc2_);
         ...
         {
            _loc6_ = this.getBundles(const_801);
            _loc7_ = false;
            ...
            _loc9_ = this.var_959.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      {
         var _loc2_:IssueHandler = this.var_637.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_637.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_779.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_93.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
         ...
         for each(_loc4_ in this.var_93)
         {
            switch(param1)
            {
               case const_1045:
                  ...
                  break;
               case const_801:
                  if(_loc4_.state == IssueMessageData.const_334 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_637.remove(param1);
         this.var_637.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_637.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_334 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.getPrioritySum() > _loc3_.getPrioritySum()))
            {
               _loc3_ = _loc5_;
            }
         }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_637.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
