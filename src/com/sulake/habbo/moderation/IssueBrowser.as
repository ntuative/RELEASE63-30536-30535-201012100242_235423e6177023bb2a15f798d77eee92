package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1834:String = "my_issues";
      
      private const const_1835:String = "open_issues";
      
      private const const_1833:String = "picked_issues";
      ...
      private var var_1684:IIssueBrowserView;
      
      private var var_1685:IIssueBrowserView;
      
      private var var_1683:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_324.view.width = this.var_237.container.width;
         this.var_324.view.height = this.var_237.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1834:
               ...
               {
                  this.var_1684 = new MyIssuesView(this.issueManager,this,this.var_237.container);
               }
               return this.var_1684;
            case this.const_1835:
               if(this.var_1685 == null)
               {
                  this.var_1685 = new OpenIssuesView(this.issueManager,this,this.var_237.container);
               }
               return this.var_1685;
            case this.const_1833:
               if(this.var_1683 == null)
               {
                  this.var_1683 = new PickedIssuesView(this.issueManager,this,this.var_237.container);
               }
