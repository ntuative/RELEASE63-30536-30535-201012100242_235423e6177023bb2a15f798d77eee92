package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1057:IWindowContainer;
      ...
      {
         this.var_1057 = IWindowContainer(this.var_44.getXmlWindow("chatlog_roomheader"));
         this.var_1056 = IWindowContainer(this.var_44.getXmlWindow("chatlog_chatline"));
         ...
         this.var_44.connection.send(this.var_1775);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(this.var_1057.clone());
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(this.var_1056.clone());
         _loc4_.color = this.var_1679[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
