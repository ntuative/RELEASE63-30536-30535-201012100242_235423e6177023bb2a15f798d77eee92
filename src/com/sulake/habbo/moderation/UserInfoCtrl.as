package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_862:int = 3600;
      
      private static const const_863:int = 86400;
      
      private static const const_865:int = 31536000;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_862) + " hours ago";
         }
         if(param1 < 2 * const_865)
         {
            return Math.round(param1 / const_863) + " days ago";
         }
         return Math.round(param1 / const_865) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_44,WindowTracker.const_942,this._data.userId),this._callerFrame,this.var_1019,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new RoomVisitsCtrl(this.var_44,this._data.userId),this._callerFrame,this.var_1019,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new SendMsgsCtrl(this.var_44,this._data.userId,this._data.userName,this.var_1212),this._callerFrame,this.var_1019,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_44.windowTracker.show(new ModActionCtrl(this.var_44,this._data.userId,this._data.userName,this.var_1212),this._callerFrame,this.var_1019,false,true);
      }
