package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadLibrary extends EventDispatcher
   {
      ...
      private static var var_1570:int = 1;
      ...
      public function AvatarAssetDownloadLibrary(param1:String, param2:String, param3:String, param4:IAssetLibrary)
      {
         ...
         this._state = name_1;
         this._assets = param4;
         this.var_821 = String(param1);
         this._revision = String(param2);
         this.var_1255 = param3 + this.var_821 + ".swf";
         this.var_1255 = this.var_1255.replace("%revision%",this._revision);
         var _loc5_:AssetLibraryCollection = this._assets as AssetLibraryCollection;
         var _loc6_:IAssetLibrary = _loc5_.getAssetLibraryByUrl(this.var_821 + ".swf");
         if(_loc6_ != null)
         {
            Logger.log("[AvatarAssetDownloadLibrary] Already Downloaded by Core: " + this.var_821);
            this._state = name_2;
         }
      }
      ...
      {
         this._state = var_1570;
         var _loc1_:URLRequest = new URLRequest(this.var_1255);
      ...
      {
         var _loc1_:String = this.var_821;
