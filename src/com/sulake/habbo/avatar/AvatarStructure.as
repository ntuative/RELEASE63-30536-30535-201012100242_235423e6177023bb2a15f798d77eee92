package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         super();
         this.var_384 = param1;
         this.var_320 = new FigureData();
         this.var_379 = new PartSetsData();
         this.var_444 = new AnimationData();
         this.var_692 = new AnimationManager();
         this.var_464 = param2;
      ...
      {
         this.var_1305.loadOffsets(param1);
      }
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_464);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_464);
            return;
         }
         this.var_847 = new AvatarActionManager(param1,this.var_464,param2);
         this.var_846 = this.var_847.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_464);
            return false;
         }
         if(this.var_379.parse(param1))
         {
            if(this.var_464 == AvatarType.const_111)
            {
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_464);
            return false;
         }
         return this.var_444.parse(param1);
      }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_464);
            return false;
         }
         return this.var_320.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_320.injectXML(param1);
      }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_692.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_320.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_320.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_692.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_692.getAnimation(param1) as Animation;
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_574[param1] = new Dictionary();
         }
         if(this.var_574[param1][param2])
         {
            return this.var_574[param1][param2];
         }
         this.var_574[param1][param2] = this.var_320.getMandatorySetTypeIds(param1,param2);
         return this.var_574[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_320.getDefaultPartSet(param1,param2);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_692.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1329[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc13_:* = [0];
         var _loc14_:AnimationAction = this.var_444.getAction(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc23_ = param3.definition.state + "." + param3.actionParameter;
            _loc9_ = this.var_692.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_320.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_320.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
      ...
      {
         return this.var_1305.getOffset(param1,param2,param3,param4,param5,param6);
      }
