package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1169:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      ...
      private var var_691:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_987:AvatarEditorHandler;
      ...
      private var var_800:IFigureData;
      ...
      {
         this.var_827 = FigureData.const_68;
      ...
      private function init() : void
      {
         ...
         if(!this.var_172)
         {
            ...
            this.var_544["null"] = new FigureData(this);
            _loc1_ = this.var_544["null"];
            _loc2_ = this.var_544["null"];
            _loc1_.loadAvatarData(const_1169,FigureData.const_68);
            _loc2_.loadAvatarData(const_1171,FigureData.FEMALE);
            this.var_91 = new Map();
            this.var_438 = new Map();
            this.var_91.add(AvatarEditorFigureCategory.const_574,new BodyModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_42,new HeadModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_241,new TorsoModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_561,new LegsModel(this));
            this.var_91.add(AvatarEditorFigureCategory.const_955,new HotLooksModel(this));
            this.var_438.add(AvatarEditorSideCategory.const_96,new WardrobeModel(this));
            this.var_438.add(AvatarEditorSideCategory.const_396,new ClubPromoModel(this));
            this.var_172 = true;
         }
      }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_800.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_800.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_231 == null)
            {
               this.var_231 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_55,HabboWindowStyle.const_34,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_231.addChild(this._view.window);
               if(param5)
               {
                  this.var_231.center();
               }
            ...
            this.var_231.visible = !this.var_231.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_574);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_438.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_691 = param2 as ISessionDataManager;
      }
      ...
      {
         this.var_800 = this.var_439.getFigureData(AvatarType.const_111);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_987 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_544[this.var_827];
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1509;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_988 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1170)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1404.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1457)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_988 >= _loc6_.clubLevel))
               {
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_988 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_438.getValue(AvatarEditorSideCategory.const_96);
      }
