package com.sulake.habbo.avatar
{
   ...
   public class AvatarAssetDownloadManager extends EventDispatcher
   {
      ...
      private var var_380:AssetLoaderStruct;
      ...
      private const const_1824:int = 100;
      
      private const const_1441:int = 2;
      ...
      public function AvatarAssetDownloadManager(param1:IAssetLibrary, param2:String, param3:String, param4:AvatarStructure)
      {
         ...
         if(_loc6_ == null)
         {
            this.var_380 = this._assets.loadAssetFromFile("figuremap",_loc5_,"text/xml");
         ...
         this.var_849 = new Timer(this.const_1824,1);
      ...
      private function addMapLoaderEventListeners() : void
      {
         if(this.var_380)
         {
            this.var_380.addEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_380.addEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function removeMapLoaderEventListeners() : void
      {
         if(this.var_380)
         {
            this.var_380.removeEventListener(AssetLoaderEvent.const_30,this.onConfigurationComplete);
            this.var_380.removeEventListener(AssetLoaderEvent.const_43,this.onConfigurationError);
         }
      }
      ...
      private function onConfigurationError(param1:Event) : void
      {
         ...
         else
         {
            ...
            if(this.var_1311.indexOf("?") > 0)
            {
               _loc2_ = this.var_1311 + "&retry=" + this.var_851;
            }
            else
            {
               _loc2_ = this.var_1311 + "?retry=" + this.var_851;
            ...
            this.var_380 = this._assets.loadAssetFromFile("figuremap",_loc3_,"text/xml");
            this.addMapLoaderEventListeners();
         }
      }
      ...
      private function generateMap(param1:XML) : void
      {
         ...
         {
            _loc3_ = new AvatarAssetDownloadLibrary(_loc2_.@id,_loc2_.@revision,this.var_2273,this._assets);
      ...
      public function loadFigureSetData(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         if(!this.var_1661)
         {
            this.var_1052.push([param1,param2]);
            return;
         }
      ...
      {
         var _loc1_:* = null;
         while(this.var_693.length > 0 && this.var_694.length < this.const_1441)
         {
            _loc1_ = this.var_693[0];
            _loc1_.startDownloading();
            this.var_694.push(this.var_693.shift());
         }
      }
      
      private function addToQueue(param1:AvatarAssetDownloadLibrary) : void
      {
         if(!param1.isReady && this.var_693.indexOf(param1) == -1 && this.var_694.indexOf(param1) == -1)
         {
