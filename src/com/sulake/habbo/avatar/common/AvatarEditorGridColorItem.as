package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_867 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_867.width,this.var_867.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_867,this.var_867.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_866)
            {
               switch(this.var_866.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_59:
                     _loc4_.style = HabboIconType.const_580;
                     _loc4_.visible = true;
                     break;
