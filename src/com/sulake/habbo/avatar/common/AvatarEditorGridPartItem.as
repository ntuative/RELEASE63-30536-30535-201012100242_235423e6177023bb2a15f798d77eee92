package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_697:IFigurePartSet;
      ...
      private var var_577:Rectangle;
      
      private var var_1670:int = 0;
      
      private var var_384:IAvatarRenderManager;
      ...
      private const const_1810:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 != null)
         {
            ...
            {
               this.var_1670 = Math.max(this.var_1670,_loc6_.colorLayerIndex);
            }
         }
         this.var_384 = this.var_62.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_620 != null && !this.var_1672)
            {
               _loc3_ = this.var_620;
            }
            else
         ...
         {
            this._window.color = this.const_1810;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:AvatarFigureContainer = this.var_384.createFigureContainer(this.partSet.type + "-" + this.partSet.id);
         Logger.log("QUERYING SET:" + this.partSet.type + "-" + this.partSet.id);
         if(!this.var_384.isFigureReady(_loc1_))
         {
            this.var_384.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               ...
               _loc4_ = this.var_384.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_577 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1671)
               {
                  ...
                  this.var_1671 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_577.width,this.var_577.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_577.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_577.y;
               if(this.var_1672 && _loc2_.colorLayerIndex > 0)
               {
