package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2464 = parseInt(param1.@paletteid);
         this.var_602 = new Dictionary();
         this.var_602["F"] = new Dictionary();
         this.var_602["M"] = new Dictionary();
         this.var_602["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_602["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_602["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_602["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      {
         return this.var_602[param1.toUpperCase()][Math.min(param2,1)];
      }
