   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_175,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_238,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_62,FigureData.const_255,_windowManager,_assetLibrary);
         ...
         if(var_62 && var_128 == "")
         {
            var_62.switchCategory(FigureData.const_175);
         }
      }
