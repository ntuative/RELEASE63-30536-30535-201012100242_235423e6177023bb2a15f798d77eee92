package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         super();
         this.var_1098 = new Matrix4x4();
         this.var_723 = new Dictionary();
         this.var_1770 = new Dictionary();
         this.var_1769 = new AvatarSet(param1.avatarset[0]);
         ...
         for each(_loc6_ in param1.type)
         {
            ...
            this.var_1770[String(_loc6_.@id)] = _loc8_;
         }
      }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = this.var_1769.findAvatarSet(param1);
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:AvatarSet = this.var_1769.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = this.var_142[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartOfItem(param1:String, param2:String) : GeometryBodyPart
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc3_:Dictionary = this.var_1770[param1];
         if(_loc3_ != null)
         {
      ...
      public function getBodyPartsAtAngle(param1:String, param2:uint, param3:String) : Array
      {
         ...
         this.var_1098 = Matrix4x4.getYRotationMatrix(param2);
         for each(_loc7_ in _loc5_)
         {
            _loc7_.applyTransform(this.var_1098);
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(this.hasBodyPart(param1,param2))
         {
            ...
            this.var_1098 = Matrix4x4.getYRotationMatrix(param3);
            return _loc5_.getParts(this.var_1098,this.var_894,param4);
         }
         return [];
      }
