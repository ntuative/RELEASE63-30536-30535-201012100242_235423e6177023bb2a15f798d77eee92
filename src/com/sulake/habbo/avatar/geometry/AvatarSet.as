package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarSet
   {
      ...
      public function AvatarSet(param1:XML)
      {
         ...
         this.var_2240 = _loc2_ == null ? false : Boolean(Boolean(parseInt(_loc2_)));
         ...
         {
            this.var_1636.push(String(_loc5_.@id));
         }
         _loc6_ = this.var_1636.concat();
         for each(_loc3_ in this.var_1041)
         {
            _loc6_ = _loc6_.concat(_loc3_.getBodyParts());
         }
         this.var_2241 = _loc6_;
      }
