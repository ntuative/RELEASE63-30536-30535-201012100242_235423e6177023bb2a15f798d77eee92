package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1176:String = "Default";
      
      private static const const_1177:int = 2;
      
      private static const const_1178:String = AvatarSetType.const_32;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1178,const_1177);
         this.var_287 = new Array();
         this.var_846 = new ActiveActionData(AvatarAction.const_341);
         this.var_846.definition = this._structure.getActionDefinition(const_1176);
         this.resetActions();
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param2 < AvatarDirectionAngle.const_1092)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_547,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_262.length == 1 && this.var_85 == this.var_1864)
         {
            return this.var_85 + this.var_440 + this.var_547 % 4;
         }
         if(this.var_262.length == 2)
         {
            for each(_loc1_ in this.var_262)
            {
               ...
               {
                  return this.var_85 + this.var_440 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_547 % 11;
                  return this.var_85 + "_" + this.var_1864 + this.var_440 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2060 || param2 != this.var_2061 || param1 != this.var_2059)
         {
            this.var_2060 = param3;
            this.var_2061 = param2;
            this.var_2059 = param1;
            this.var_1521 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1154 || this.var_39 == null || (this.var_39.width != _loc5_.width || this.var_39.height != _loc5_.height))
         {
            if(this.var_39 != null && !this.var_1154)
            {
               this.var_39.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_547);
         ...
         if(this.var_501 != null)
         {
            if(this.var_501.paletteIsGrayscale)
            {
               ...
               this.var_39 = _loc13_;
               this.var_39.paletteMap(this.var_39,this.var_39.rect,new Point(0,0),this.var_501.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_547);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_287.push(new ActiveActionData(param1,param2,this.var_547));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_254 = this.var_846;
         this.var_254.definition = this.var_846.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_440 = "";
         this.var_262 = this._structure.sortActions(this.var_287);
         if(this.var_262 == null)
         {
         ...
         {
            this.var_683 = this._structure.getCanvasOffsets(this.var_262,this._scale,this.var_85);
            for each(_loc4_ in this.var_262)
            {
               this.var_440 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_295)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1239 != _loc5_)
                  {
                     _loc2_ = true;
                  }
                  this.var_1239 = _loc5_;
                  _loc3_ = true;
               }
            }
            if(!_loc3_)
            ...
            if(this.var_1241 != this.var_440)
            {
               _loc1_ = true;
               this.var_1241 = this.var_440;
            }
         }
         this.var_1240 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_262)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_765 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     this.var_176 = this.var_176.concat(_loc2_.spriteData);
               ...
               if(_loc1_.actionType == AvatarAction.const_302 || _loc1_.actionType == AvatarAction.const_215 || _loc1_.actionType == AvatarAction.const_316)
               {
                  this.var_765 = true;
               }
            }
