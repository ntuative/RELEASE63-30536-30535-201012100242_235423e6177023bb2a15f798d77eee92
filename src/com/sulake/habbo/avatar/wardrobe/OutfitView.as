package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class OutfitView
   {
      ...
      public function udpate(param1:BitmapData) : void
      {
         ...
         var _loc2_:int = (this.var_385.width - param1.width) / 2;
         var _loc3_:int = this.var_385.height - param1.height;
         this.var_385.bitmap.copyPixels(param1,param1.rect,new Point(_loc2_,_loc3_));
      }
