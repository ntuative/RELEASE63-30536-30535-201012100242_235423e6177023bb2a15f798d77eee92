package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit, IAvatarImageListener
   {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IAvatarImage = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_83,this.var_827,this);
         if(_loc1_)
         {
            _loc1_.setDirection(AvatarSetType.const_32,int(FigureData.const_816));
