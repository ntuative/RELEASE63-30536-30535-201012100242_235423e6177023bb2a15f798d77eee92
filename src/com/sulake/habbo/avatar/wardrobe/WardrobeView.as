package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_905:IItemListWindow;
      
      private var var_1117:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         this.var_905 = this._window.findChildByName("hc_slots") as IItemListWindow;
         this.var_1117 = this._window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(this.var_905)
         {
            this.var_905.removeListItems();
         }
         if(this.var_1117)
         {
            this.var_1117.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(this.var_905)
               {
                  this.var_905.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(this.var_1117)
            {
               this.var_1117.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
