package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1823:String = "hd-99999-99999";
      ...
      private var var_687:PaletteManager;
      
      private var var_514:String;
      
      private var var_274:Map;
      
      private var var_199:AvatarAssetDownloadManager;
      
      private var var_1644:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_514 = RenderMode.const_1450;
         ...
         this.var_95.add(AvatarType.const_111,_loc4_);
         ...
         this.var_95.add(AvatarType.const_65,_loc4_);
         ...
         this.var_687 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_199)
         {
            this.var_199.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_316.init();
         this.var_687.init();
         _loc2_ = this.var_95.getValue(AvatarType.const_111) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_95.getValue(AvatarType.const_65) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_95.getValue(AvatarType.const_111) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_154.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_199 == null)
               {
                  ...
                  _loc6_ = this.var_154.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_154.getKey("flash.dynamic.avatar.download.url","");
                  this.var_199 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_199.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_855)
         {
            if(this.var_2258 && this.var_2259 && this.var_2260)
            {
      ...
      public function isFigureReady(param1:AvatarFigureContainer) : Boolean
      {
         ...
         return this.var_199.isReady(param1);
      }
      ...
      public function downloadFigure(param1:AvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_199.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_95.getValue(AvatarType.const_111) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_199.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1644)
         {
            this.var_1644 = new AvatarFigureContainer(this.const_1823);
         }
         this.var_199.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1644,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1506)
         {
            _loc6_ = !this.var_316.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_316.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_95.getValue(AvatarType.const_65) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_95.getValue(AvatarType.const_65);
      ...
      {
         var _loc3_:AvatarStructure = this.var_95.getValue(AvatarType.const_111) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_65:
               _loc3_ = this.var_95.getValue(AvatarType.const_65) as AvatarStructure;
               break;
            default:
