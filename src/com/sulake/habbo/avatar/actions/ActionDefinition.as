package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_2248 = String(param1.@assetpartdefinition);
         this.var_2242 = String(param1.@lay);
         this.var_715 = String(param1.@geometrytype);
         this.var_2240 = Boolean(parseInt(param1.@main));
         this.var_2244 = Boolean(parseInt(param1.@var_580));
         this.var_2247 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            {
               this.var_1637[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_405[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1637[param1];
         if(_loc2_ == null)
         {
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_405[param1];
         if(_loc2_ != null)
         {
