package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_1501:AvatarDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         if(param2.hasOwnProperty("sprite"))
         {
            ...
            {
               this.var_1228.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_1501 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1227.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_1503 = new DirectionDataContainer(param2.direction[0]);
         }
         ...
         if(param2.hasOwnProperty("remove"))
         {
            ...
            {
               this.var_1229.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_660.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("HabboNavigatorCom_rico_bg6_png"))
         {
            this._overrideFrames = new Map();
            this.var_543 = new Map();
            for each(_loc7_ in param2.HabboNavigatorCom_rico_bg6_png)
            {
               _loc8_ = _loc7_.@name;
               _loc9_ = _loc7_.@HabboNavigatorCom_rico_bg6_png;
               this.var_543.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc8_ in _loc7_.bodypart)
            {
               ...
               _loc10_ = new AnimationLayerData(param3,_loc8_,AnimationLayerData.const_687,_loc6_,_loc5_);
               _loc4_.push(_loc10_);
            }
      ...
      public function overridingAction(param1:String) : String
      {
         ...
         return this.var_543.getValue(param1);
      }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         {
            if(_loc4_.type == AnimationLayerData.const_687)
            {
               _loc3_.push(_loc4_.id);
            }
            else if(_loc4_.type == AnimationLayerData.const_446)
            {
               for each(_loc5_ in this.var_660)
               {
