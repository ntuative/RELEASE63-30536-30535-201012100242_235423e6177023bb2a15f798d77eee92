package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_831:int = 100;
      ...
      private var var_1913:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_120 = param1;
         this.var_1433 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_51 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_1913 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_831 + const_1144)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_1433.enable();
         }
         else
         {
            this.var_1433.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_51.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_417.messages.length - const_831);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_684 || param3.type == Message.const_589 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_120.send(new FollowFriendMessageComposer(this.var_417.id));
      }
