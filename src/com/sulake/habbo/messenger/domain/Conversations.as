package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_728,0,this.var_386.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      {
         this._startIndex = Math.min(this._startIndex,this.var_121.length - this.var_386.getTabCount());
         this._startIndex = Math.max(0,this._startIndex);
      }
      
      private function getOnlineInfoMsg(param1:Boolean) : Message
      {
         return new Message(Message.const_750,0,this.getOnlineText(param1),Util.getFormattedNow());
      }
