package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1247:String = "pixelbalance";
      
      private static const const_1245:String = "badges";
      
      private static const const_1244:String = "selectbadge";
      
      private static const const_1242:String = "inventory";
      
      private static const const_1248:String = "selectfurni";
      
      private static const const_1249:String = "credits";
      
      private static const const_1243:String = "friendlist";
      ...
      private var var_738:IHabboToolbar;
      ...
      private var var_916:ClubPromoNotification;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_738)
         {
            this.var_738.release(new IIDHabboToolbar());
            this.var_738 = null;
         }
      ...
      {
         this.var_738 = IHabboToolbar(param2);
         this.var_738.events.addEventListener(HabboToolbarEvent.const_69,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_69)
         {
            ...
            this.var_497 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_915["styles"],this.var_915["view"],this.var_738);
            ...
            this.var_738.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,this.onToolbarRepositionEvent);
         }
      }
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1395[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_404);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1297);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_404.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1036);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1036);
            }
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_439.createAvatarImage(param2,AvatarScaleType.const_47);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1473,_loc5_);
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1083)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1477);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1475)
         {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_916 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function onInfoFeedEnable(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1817 = !_loc2_.enabled;
         }
      }
      
      public function update(param1:uint) : void
      {
         if(this.var_497.isSpaceAvailable() && this.var_1137.length > 0)
         {
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1245:
               ...
               {
                  this._inventory.toggleInventoryPage(InventoryCategory.const_300);
               }
               break;
            case const_1244:
               break;
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_439.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_47);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_439.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_47);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2556)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1102);
            this.var_2556 = true;
      ...
      {
         if(param2.type == WindowEvent.const_167 || param2.type == WindowEvent.const_619)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1102,_loc6_);
      }
   }
}
