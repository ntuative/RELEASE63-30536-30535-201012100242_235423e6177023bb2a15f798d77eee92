package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_608:ToolbarBarMenuAnimator;
      ...
      private var var_1965:int = 5;
      
      private var var_1963:int;
      
      private var var_146:Number;
      
      private var var_1964:XML;
      ...
      {
         return this.var_1202.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_1964.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         return this.var_635.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1200.length)
         {
            _loc2_ = this.var_635.indexOf(this.var_1200[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_259[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1046 + _loc3_);
                  _loc3_ += this.var_1201;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_259[this.var_635.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_608);
         this.var_35.addChild(_loc2_.window);
         this.var_635.push(param1);
         this.var_259.push(_loc2_);
         return _loc2_;
      }
   }
}
