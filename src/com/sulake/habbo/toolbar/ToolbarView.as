package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_208 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_934,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1111 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1111)
         {
         ...
         this.var_1112 = _loc6_.toolbar.@margin_top;
         this.var_1375 = _loc6_.toolbar.@margin_bottom;
         this.var_1786 = _loc6_.toolbar.@min_group_margin;
         this.var_1785 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_285 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_248,param1,param2,this._window,this.var_285);
         this.createGroupsFromXmlList(_loc8_,this.var_604,param1,param2,this.var_208,this.var_285);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_146,this.var_490,param3);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_146,this.var_490);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_146,this.var_490);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_604.length)
         {
            _loc2_ = this.var_604[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_208.x = this.var_146 + this.var_1785;
               this.var_208.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_208.x = 0;
               this.var_208.y = this.var_146 + this.var_1785;
         ...
         _loc4_ -= this.var_1375;
         _loc4_ -= this.var_1112;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1112;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_248.length > 1)
            {
               ...
               {
                  _loc6_ = Number(Math.max(this.var_1786,(this._window.height - _loc5_ * _loc8_ - this.var_1112 - this.var_1375) / (this.var_248.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1786,(this._window.width - _loc5_ * _loc8_ - this.var_1112 - this.var_1375) / (this.var_248.length - 1)));
               }
            }
         }
         _loc2_ = 0;
      ...
      private function onStageMouseMove(param1:MouseEvent) : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_1111 && this.var_1374)
         {
