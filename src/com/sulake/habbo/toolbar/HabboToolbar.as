package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_267.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(this.onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_102,this.onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_1026,this.onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_896,this.onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_945,this.onHideWindowEvent);
         this._state = true;
