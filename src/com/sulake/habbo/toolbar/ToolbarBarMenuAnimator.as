package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1131:Number = 25;
      
      private static const const_1128:Number = 90;
      
      private static const const_888:int = 50;
      
      private static const const_1250:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1396:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         this.var_739 = new Timer(const_1131);
      ...
      {
         return param1.x + param1.width < const_888 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_888 || param1.desktop.height - param1.y < const_1250;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1396.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      {
         var _loc2_:Point = this.var_1396.getIconLoc(param1.iconId);
      ...
      {
         return this.var_612[this.var_613.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_613[this.var_612.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_613.indexOf(param2);
         if(_loc3_ > -1)
         {
         ...
         this.var_613.push(param2);
         param1.addEventListener(WindowEvent.const_349,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_210,this.windowEventListener);
      }
