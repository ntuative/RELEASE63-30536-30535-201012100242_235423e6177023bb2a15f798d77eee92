package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketplaceChart
   {
      ...
      public function draw(param1:int, param2:int) : BitmapData
      {
         ...
         {
            if(_loc4_ > this.var_553)
            {
               this.var_553 = _loc4_;
            }
         }
         _loc5_ = Math.pow(10,int(this.var_553).toString().length - 1);
         this.var_553 = Math.ceil(this.var_553 / _loc5_) * _loc5_;
         ...
         _loc6_.text = this.var_553.toString();
         _loc3_.draw(_loc6_);
         this.var_999 = param1 - _loc6_.textWidth - 2;
         ...
         while(_loc10_ <= 5)
         {
            ...
            _loc9_.graphics.lineTo(this.var_999 - 1,_loc4_);
            _loc10_++;
         }
         ...
         _loc3_.draw(_loc9_,new Matrix(1,0,0,1,param1 - this.var_999,(param2 - this.var_819) / 2));
         return _loc3_;
      }
      
      private function getX(param1:int) : Number
      {
         return this.var_999 + this.var_999 / -this.var_2631 * this._x[param1];
      }
      
      private function getY(param1:int) : Number
      {
         return this.var_819 - this.var_819 / this.var_553 * this.var_163[param1];
      }
