package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1202:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1300:XML;
      
      private static var var_1298:XML;
       
      
      private var var_1642:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1642 == 4294967295)
            {
               this.var_1642 = _loc1_.color;
            }
            _loc1_.color = const_1202;
         }
      }
      ...
      {
         this.var_51 = navigator.catalog.windowManager.buildFromXML(var_1298) as IItemListWindow;
         if(this.var_51 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1300) as IWindowContainer;
         }
         else
         {
