package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2664:String = "magic.credits";
      
      private var var_2618:String = "magic.pixels";
      
      private var var_2617:String = "catalog.page.club";
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = this.var_293.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in this.var_293)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = this.var_293.indexOf(_loc6_);
            this.var_293.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
         ...
         if(this.var_293.indexOf(param1) == -1)
         {
      ...
      {
         this.openPage(this.var_2618);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2617,true);
      }
