package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_2347:GiftWrappingConfiguration;
      
      private var var_1067:ClubGiftController;
      
      private var var_474:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         {
            this.var_474.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_109.getActivityPointsForType(Purse.const_439)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_102,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_82:
               this.var_1708 = param1.session.isPrivateRoom;
               if(this.var_89 != null)
               {
      ...
      private function createClubBuyController() : void
      {
         if(this.var_474 == null)
         {
            this.var_474 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         if(this.var_710 && this.var_710 != "")
         {
            this.var_328.openPage(this.var_710);
            this.var_710 = "";
            this.var_865 = -1;
         }
         else if(this.var_865 > -1)
         {
            this.var_328.openPageById(this.var_865,this.var_1709);
            this.var_865 = -1;
            this.var_1709 = -1;
            this.var_710 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2348 && this.var_592 != null)
         {
            this.var_592.playSound(HabboSoundTypesEnum.const_918);
         }
         this.var_2348 = false;
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2346 && this.var_592 != null)
         {
            this.var_592.playSound(HabboSoundTypesEnum.const_1067);
         }
         this.var_2346 = false;
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2347 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == this.var_154.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_154.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_167)
         {
            _loc3_ = this.var_154.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
