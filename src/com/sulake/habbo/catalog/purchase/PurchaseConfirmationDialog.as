package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_533:IWindowContainer;
      
      private var var_297:int = -1;
      
      private const const_1811:int = 10;
      ...
      private const const_1578:uint = 4.293848814E9;
      
      private const const_1579:uint = 4.294967295E9;
      
      private const const_1812:uint = 4.291613146E9;
      ...
      private function updateLocalizations() : void
      {
         ...
         var _loc8_:String = this.var_80.activityPointType == Purse.const_439 ? "pixels" : "activitypoints";
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_651 = _loc1_.ribbonTypes;
            this.var_973 = this.var_1489[0];
            this.var_299 = this.var_650[0];
            this.var_298 = this.var_651[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_298 < 0)
         {
            this.var_298 = this.var_651.length - 1;
         }
         if(this.var_298 > this.var_651.length - 1)
         {
            this.var_298 = 0;
         }
         if(this.var_299 < 0)
         {
            this.var_299 = this.var_650.length - 1;
         }
         if(this.var_299 > this.var_650.length - 1)
         {
            this.var_299 = 0;
         }
         var _loc1_:int = this.var_650[this.var_299] * 1000 + this.var_651[this.var_298];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_80.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_973,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1219 = _loc3_.id;
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_973);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_650[this.var_299]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_651[this.var_298]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_80,this.var_1218,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_80.offerId,this.var_1218);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_103:
               ...
               if(this.var_1998 == _loc3_.text)
               {
                  return;
               }
               _loc4_ = _loc3_.text.toLowerCase();
               _loc5_ = [];
               for each(_loc7_ in this.var_193)
               {
                  if(_loc7_.toLowerCase().search(_loc4_) != -1)
                  {
                     _loc5_.push(_loc7_);
                  }
                  if(_loc5_.length >= this.const_1811)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_1998 = _loc3_.text;
               break;
            case WindowMouseEvent.const_38:
               ...
               break;
            case WindowKeyboardEvent.const_736:
      ...
      {
         if(this.var_226 == null || !this.var_226.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_226.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_226 == null)
         {
            this.var_226 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_533 == null)
         {
            this.var_533 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_533.procedure = this.suggestionsEventHandler;
         }
         if(this.var_226 == null || this.var_533 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_226.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_533.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1812;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1578) : uint(this.const_1579);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_226.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_973;
               }
            }
            _loc4_++;
         }
