package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_848:int = 0;
      ...
      {
         return this.var_557 != const_848;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1569 != RecyclerStatusMessageEvent.const_967;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_557 == const_388;
      }
      ...
      {
         this.var_557 = const_849;
         this.var_103 = new Array(const_160);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1569)
         {
            case RecyclerStatusMessageEvent.const_1301:
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_967:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1083:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1478:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_103.length < const_160)
         {
            return false;
         }
         var _loc1_:int = 0;
