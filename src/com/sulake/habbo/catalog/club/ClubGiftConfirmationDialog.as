package com.sulake.habbo.catalog.club
{
   ...
   public class ClubGiftConfirmationDialog
   {
      ...
      public function showConfirmation() : void
      {
         ...
         if(!this.var_80.productContainer)
         {
            return;
         }
         this.var_80.productContainer.view = _loc2_;
         this.var_80.productContainer.initProductIcon(this._controller.roomEngine);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "select_button":
               this._controller.confirmSelection(this.var_80.localizationId);
               break;
