package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_1561:int = 1;
      
      private const const_1560:int = 2;
      
      private const const_1831:int = 40;
      
      private const const_1832:int = 10;
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_580)
         {
            ...
            this.var_580 = _loc4_.buildFromXML(_loc3_) as IWindowContainer;
         }
         if(!this.var_580)
         {
            return;
         ...
         this.updateStatusDisplay(this.const_1560,_loc2_.length);
         if(!this.var_468)
         {
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1058 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1058));
            ++this.var_1058;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_580 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_580.clone() as IWindowContainer;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_1561);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         else if(param1.type == WindowEvent.const_103)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_1832;
                  break;
               case "search_input":
                  _loc8_ = this.const_1831;
                  break;
               default:
                  return;
            }
