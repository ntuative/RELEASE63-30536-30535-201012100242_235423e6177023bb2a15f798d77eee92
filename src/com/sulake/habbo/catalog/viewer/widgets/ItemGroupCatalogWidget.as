package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         var _loc2_:Offer = this.var_614[this.var_1141][this.var_1822];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         this.var_1141 = var_1168.getGridItemIndex(param1.view);
         var _loc2_:String = this._groupNames[this.var_1141];
         var _loc3_:Array = this.var_614[this.var_1141] as Array;
      ...
      override protected function populateItemGrid() : void
      {
         ...
         {
            if(this.var_1822 < _loc1_.length)
            {
               _loc2_ = _loc1_[this.var_1822] as Offer;
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_451 || _loc1_.pricingModel == Offer.const_495)
            {
