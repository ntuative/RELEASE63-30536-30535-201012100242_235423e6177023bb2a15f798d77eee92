package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      {
         super.init();
         this.var_1139 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(this.var_1139 != null)
         {
            this.var_1139.addEventListener(WindowKeyboardEvent.const_736,this.onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(this.var_1139.text));
      }
   }
}
