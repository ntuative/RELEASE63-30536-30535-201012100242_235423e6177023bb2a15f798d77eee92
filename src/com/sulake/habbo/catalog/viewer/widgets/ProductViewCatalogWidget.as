package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      {
         this.var_830 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1016 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_81 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1588 = new Point(this.var_81.x,this.var_81.y);
         this.var_449 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1268 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1587 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_830.text = _loc4_;
         this.var_1016.text = _loc5_;
         this.var_830.height = this.var_830.textHeight + 5;
         this.var_1016.y = this.var_830.y + this.var_830.height;
         this.var_1016.height = Math.max(130,this.var_1016.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_532:
                  _loc6_ = this.var_1587.clone();
                  if(this.var_449 != null)
                  {
                     this.var_449.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_449,this.var_1268,this.var_1781);
                     this.var_449.scrollV = 0;
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_230:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_271,AvatarAction.const_461);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2175)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2175 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_81 != null && true)
         {
            ...
            this.var_81.x = this.var_1588.x;
            this.var_81.y = this.var_1588.y;
            if(param3 != null)
            {
