package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_190)
         {
            this.var_190 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_190)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = this.var_190.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         this.var_190.setGlobalPosition(_loc6_.subtract(new Point(this.var_190.width / 2,this.var_190.height / 2)));
