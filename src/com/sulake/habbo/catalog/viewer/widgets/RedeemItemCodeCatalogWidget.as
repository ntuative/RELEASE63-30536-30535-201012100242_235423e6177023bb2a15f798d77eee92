package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_942:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_942.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         if(this.var_943 != null)
         {
            this.var_943.removeEventListener(WindowKeyboardEvent.const_141,this.windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         this.var_942 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_942 != null)
         {
            this.var_942.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_943 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_943 != null)
         {
            this.var_943.addEventListener(WindowKeyboardEvent.const_141,this.windowKeyEventProcessor);
         }
      }
