package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1106:PrizeViewer;
      ...
      override public function init() : void
      {
         var _loc1_:* = null;
         super.init();
         this.var_1106 = new PrizeViewer();
         this.var_729 = this.recycler.getPrizeTable();
         ...
         if(this.var_729.length > 0 && this.var_729[0].prizes.length > 0)
         {
            this.select(this.var_729[0].prizes[0] as IGridItem);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < this.var_729.length)
         {
            this.createLevelItem(this.var_729[_loc2_]);
            _loc2_++;
         }
      }
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         this.var_1106.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
