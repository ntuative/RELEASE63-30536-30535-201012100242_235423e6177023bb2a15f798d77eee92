package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid, IAvatarImageListener
   {
      ...
      {
         (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(this.var_674,page.pageId);
      }
      
      private function onBotDefinitions(param1:RentableBotDefinitionWidgetEvent) : void
      {
         this.var_1267 = param1.botFigureData;
      ...
      protected function createGridItem(param1:Offer) : void
      {
         ...
         var _loc3_:String = this.var_1267.getValue(param1.productContainer.firstProduct.extraParam.toLowerCase());
         ...
         if(_loc5_)
         {
            ...
            _loc4_.invalidate();
            this.var_1582.add(_loc3_,param1.offerId);
            _loc5_.dispose();
         }
      }
      ...
      {
         var _loc1_:String = this.var_1267.getValue(this.var_674.productContainer.firstProduct.extraParam.toLowerCase());
      ...
      private function setProductData() : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc1_.registerParameter(_loc5_,"credits",String(this.var_674.priceInCredits));
            _loc1_.registerParameter(_loc5_,"pixels",String(this.var_674.priceInActivityPoints));
            _loc2_.text = _loc1_.getKey(_loc5_);
         }
         var _loc3_:IProductData = page.viewer.catalog.getProductData(this.var_674.localizationId);
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc2_:int = this.var_1582.getValue(param1);
         if(true)
         {
            return;
         }
         for each(_loc3_ in page.offers)
         {
            ...
            {
               _loc4_ = this.var_1267.getValue(_loc3_.productContainer.firstProduct.extraParam.toLowerCase());
               ...
               if(_loc7_)
               {
                  ...
                  _loc6_.invalidate();
                  _loc7_.dispose();
                  if(this.var_674.offerId == _loc2_)
                  {
                     this.updatePreviewImage();
                  }
               }
