package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function init() : void
      {
         ...
         this.var_1787 = _loc1_.content as XML;
      ...
      private function onAvailableColours(param1:CatalogWidgetColoursEvent) : void
      {
         ...
         this.var_867 = _loc4_.content as BitmapData;
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1378.length,this._colourGrid.numGridItems]);
         this._colourGrid.destroyGridItems();
         this.var_327 = null;
         for each(_loc1_ in this.var_1378)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(this.var_1787) as IWindowContainer;
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_867.width,this.var_867.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_867,this.var_867.rect,new Point(0,0),null,null,true);
