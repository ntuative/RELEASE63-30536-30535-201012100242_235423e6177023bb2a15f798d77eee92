package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1427:IProductData;
      ...
      {
         super();
         this.var_1429 = param1.productType;
         this.var_1430 = param1.furniClassId;
         this.var_1179 = param1.extraParam;
         this.var_1180 = param1.productCount;
         this.var_1428 = param1.expiration;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(this.productType)
         {
            ...
            case ProductTypeEnum.const_78:
               _loc6_ = _loc4_.getWallItemIcon(this.productClassId,param2,this.var_1179);
               break;
