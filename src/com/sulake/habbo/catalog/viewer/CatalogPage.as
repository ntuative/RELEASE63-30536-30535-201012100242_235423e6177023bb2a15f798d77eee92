package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1106:ICatalogViewer;
      ...
      {
         return this._localization.getLinks(this.var_1042);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1042);
      }
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_1875 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1875) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            this.var_58.push(this.var_1293);
         }
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1317) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1511) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1340) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1270) as IWindowContainer;
         if(_loc1_ != null)
         {
