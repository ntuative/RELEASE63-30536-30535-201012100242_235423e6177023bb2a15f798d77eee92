package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function IncomingMessages(param1:HabboInventory)
      {
         ...
         this.var_26.addHabboConnectionMessageEvent(new FurniListInsertEvent(this.method_13));
      ...
      public function method_13(param1:IMessageEvent) : void
      {
         var _loc5_:* = null;
         var _loc6_:* = null;
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_717);
         _loc2_.refreshViews();
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_300);
      }
