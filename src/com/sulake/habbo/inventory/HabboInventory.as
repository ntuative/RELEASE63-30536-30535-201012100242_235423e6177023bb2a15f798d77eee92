   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_18 != null)
         {
            ...
            this.var_18.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_411,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_46.getValue(InventorySubCategory.const_280));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_46.getValue(InventoryCategory.const_717));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_46.getValue(InventoryCategory.const_300));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_46.getValue(InventoryCategory.const_319));
      }
      ...
      {
         return PetsModel(this.var_46.getValue(InventoryCategory.const_146));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_46.getValue(InventoryCategory.const_370) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionPropertyUpdateEvent.const_411,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_404 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_18 || !this._toolbar)
         {
            return;
         }
         ...
         this.var_46.add(InventoryCategory.const_370,_loc1_);
         ...
         this.var_46.add(InventoryCategory.const_300,_loc3_);
         ...
         this.var_46.add(InventoryCategory.const_717,_loc4_);
         ...
         this.var_46.add(InventoryCategory.const_319,_loc5_);
         ...
         this.var_46.add(InventorySubCategory.const_280,_loc6_);
         ...
         this.var_46.add(InventoryCategory.const_146,_loc8_);
         this.var_172 = true;
         if(this.var_2419)
         {
            this.requestData();
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_1839);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_1009));
      }
