package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(this.var_989.add(param1.id,param1))
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1511 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.OBJECT_CATEGORY_USER,RoomObjectTypeEnum.const_250,_loc3_.figure);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1511 && param1.type == RoomEngineObjectEvent.const_237)
         {
