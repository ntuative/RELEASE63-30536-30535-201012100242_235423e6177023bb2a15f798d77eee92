package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_38:
               this.var_1182.setSelectedGridItem(this);
               this.var_1181 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1181 = false;
                  this.var_1182.placePetToRoom(this.var_1376.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this._window.color = !!this._isSelected ? uint(this.const_1809) : uint(this.const_1810);
      }
