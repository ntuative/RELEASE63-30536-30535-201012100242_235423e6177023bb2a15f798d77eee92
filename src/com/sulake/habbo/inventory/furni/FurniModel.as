package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this.var_578 = new Timer(const_1209,1);
         ...
         this.var_2307 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_857 == null)
         {
            this.var_857 = this._windowManager.buildFromXML(this.var_2307) as IWindowContainer;
         }
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_467.add(const_41,new Array());
         this.var_467.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_363 || _loc3_.category == FurniCategory.const_325 || _loc3_.category == FurniCategory.const_343)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1318 && param1.type == RoomEngineObjectEvent.const_237)
         {
            this.var_1318 = false;
         }
      }
      ...
      {
         return this.var_467.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_280:
               ...
               break;
            case InventorySubCategory.const_1006:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_467.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_467.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_587)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
