package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_437.getValue(this.var_358);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_62.getCategoryContent(this.var_358);
         if(!this.var_62.isListInited())
         {
            _loc2_ = this.const_870;
         }
         ...
         if(this.var_2010 == _loc2_)
         {
            return;
         }
         this.var_2010 = _loc2_;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_62.getGroupItemInIndex(_loc3_,this.var_358);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_689 && this.var_689.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
         ...
         else if(param1.type == WindowEvent.const_58)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_327);
            }
         }
      }
   }
