package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_762:int = 0;
      
      protected var var_620:BitmapData;
      
      protected var var_1917:int;
      
      protected var var_1411:Boolean;
      
      protected var var_1881:Boolean;
      
      protected var var_2610:BitmapData;
      
      private const const_1809:int = 8947848;
      
      private const const_1810:int = 13421772;
      
      private const const_1566:Number = 1;
      
      private const const_1565:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1882);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_762 = _loc1_.id;
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_587)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               this._window.blend = this.const_1566;
               _loc1_.blend = this.const_1566;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1881 && this.getRecyclableCount() > 0)
            {
