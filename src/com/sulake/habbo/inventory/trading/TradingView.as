package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_842:uint = 4284532064;
      
      private static const const_841:uint = 2577770;
      ...
      private var var_359:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_359 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1512 = this.createMinimizedWindow();
         }
         if(!this.var_2024)
         {
            return this.var_65;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_65)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_842) : uint(const_841);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_842) : uint(const_841);
            }
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_990)
            {
            ...
            this.var_359.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_536);
            this.var_359.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_359.hideDelayed();
         }
      }
