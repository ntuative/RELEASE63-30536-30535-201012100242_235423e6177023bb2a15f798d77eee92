package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1730 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1079 = this.var_1730.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1079)
         {
            this.var_1079.procedure = this.onButtonClick;
         }
         this.var_1080 = this.var_1730.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1080)
         {
            this.var_1080.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_241 >= this._localizations.length - 1)
         {
            this.var_1080.disable();
         }
         else
         {
            this.var_1080.enable();
         }
         if(this.var_241 <= 0)
         {
      ...
      {
         ++this.var_241;
         this.var_241 = Math.min(this.var_241,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_241;
         this.var_241 = Math.max(this.var_241,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_241][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_241][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_241][1]).value;
