package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_220[param1];
            this.var_625.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_57.furniLimit)
         {
            this.var_220[param1] = param2;
            this.var_625.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_941 = new SliderWindowController(this.var_87,IWindowContainer(this.find(this.var_86,"delay_slider_container")),this.var_87.assets,0,20,1);
         this.var_941.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_941.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_625.hideAll(this.var_220);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_941.getValue()) : 0;
      }
