package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class ConditionTypes implements ElementTypeHolder
   {
      ...
      public function ConditionTypes()
      {
         ...
         super();
         this.var_405.push(new ActorIsOnFurni());
         this.var_405.push(new FurnisHaveAvatars());
         this.var_405.push(new StatesMatch());
         this.var_405.push(new TimeElapsedMore());
         this.var_405.push(new TimeElapsedLess());
      }
