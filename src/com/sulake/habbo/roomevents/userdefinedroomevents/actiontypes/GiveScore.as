package com.sulake.habbo.roomevents.userdefinedroomevents.actiontypes
{
   ...
   public class GiveScore implements ActionType
   {
      ...
      private var var_934:SliderWindowController;
      ...
      {
         return ActionTypeCodes.var_1856;
      }
      ...
      public function readIntParamsFromForm(param1:IWindowContainer) : Array
      {
         ...
         _loc2_.push(this.var_934.getValue());
      ...
      {
         this.var_87 = param2;
         this.var_934 = new SliderWindowController(param2,this.getInput(param1),param2.assets,1,100,1);
         this.var_934.addEventListener(Event.CHANGE,this.onSliderChange);
         this.var_934.setValue(1);
         this.var_1125 = new SliderWindowController(param2,this.getCounterInput(param1),param2.assets,1,10,1);
         this.var_1125.addEventListener(Event.CHANGE,this.onCounterSliderChange);
      ...
      public function onEditStart(param1:IWindowContainer, param2:Triggerable) : void
      {
         ...
         this.var_934.setValue(_loc3_);
         this.var_1125.setValue(_loc4_);
      }
