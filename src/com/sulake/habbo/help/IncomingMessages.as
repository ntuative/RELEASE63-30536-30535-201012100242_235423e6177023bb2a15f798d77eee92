   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != this._userId && _loc5_.userType == RoomObjectTypeEnum.const_338)
            {
               this._component.userRegistry.registerUser(_loc5_.webID,_loc5_.name);
            }
            if(_loc5_.webID == this._userId)
            {
               this.var_1933 = _loc5_.id;
            }
            _loc4_++;
         }
      ...
      {
         this._component.showUI(HabboHelpViewEnum.const_351);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this._component.tellUI(HabboHelpViewEnum.const_243,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this._component.showUI(HabboHelpViewEnum.const_747);
         this._component.tellUI(HabboHelpViewEnum.const_747,_loc5_);
      }
