package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      {
         super();
         this.var_745 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_746 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_744 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
