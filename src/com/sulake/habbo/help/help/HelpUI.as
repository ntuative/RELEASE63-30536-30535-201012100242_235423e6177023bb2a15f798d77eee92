package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1552:int = 0;
      
      private static const const_1553:int = 0;
      ...
      {
         this.var_309 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012100237));
         this._toolbar = param5;
         this.var_94 = new Map();
         this.var_94.add(HabboHelpViewEnum.const_1488,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_184,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_459,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_284,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_243,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_747,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_351,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_568,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         ...
         this.var_94.add(HabboHelpViewEnum.const_1035,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_94.add(HabboHelpViewEnum.const_900,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_94.add(HabboHelpViewEnum.const_793,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_451.length == 0 || param1 != this.var_309)
            {
               this.var_451.push(this.var_309);
            }
         }
         this.var_309 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_309);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_202:
               ...
               break;
            case CallForHelpResultEnum.const_1015:
               this.showUI(HabboHelpViewEnum.const_900);
               break;
            case CallForHelpResultEnum.const_954:
               this.showUI(HabboHelpViewEnum.const_1035);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_94.getValue(HabboHelpViewEnum.const_184) as IHelpViewController;
      ...
      {
         return this.var_94.getValue(this.var_309);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1595 = this._window.width - _loc4_.width;
         this.var_1596 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1596;
         this._window.width = _loc1_.width + this.var_1595;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_451.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_309 == HabboHelpViewEnum.const_184)
         {
            return;
         }
         if(this.var_564.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_564.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_564[1],this.var_564[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_564[0],this.var_564[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_309 == HabboHelpViewEnum.const_184 || this.var_451.length == 0)
         {
            return;
         }
         if(this.var_310 == null)
