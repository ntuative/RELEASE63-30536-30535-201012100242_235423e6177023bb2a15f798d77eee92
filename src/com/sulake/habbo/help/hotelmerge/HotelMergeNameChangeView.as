package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_631)
         {
            this.var_631 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_631)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_632)
         {
            this.var_632 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_632)
            {
               return;
            }
