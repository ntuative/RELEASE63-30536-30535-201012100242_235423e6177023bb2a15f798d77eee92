package com.sulake.habbo.help.register
{
   ...
   public class RegistrationValidator
   {
      ...
      public static const const_1385:RegExp = /^[A-Z0-9._%+-]+@(?:[A-Z0-9-]+\.)+[A-Z]{2,4}$/i;
      
      public static const const_1449:RegExp = /[0-9]/;
      
      public static const const_1400:RegExp = /[a-zA-Z]/;
      ...
      {
         if(param1 == null || !param1.match(const_1385))
         {
