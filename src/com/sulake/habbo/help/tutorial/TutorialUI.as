package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      private var var_306:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         this.var_44 = param1;
         this.var_44.events.addEventListener(HabboHelpTutorialEvent.const_422,this.onTaskDoneEvent);
         this.var_44.events.addEventListener(HabboHelpTutorialEvent.const_491,this.onTaskDoneEvent);
         this.var_44.events.addEventListener(HabboHelpTutorialEvent.const_440,this.onTaskDoneEvent);
      }
      ...
      {
         return this.var_1264 && this.var_1013 && this.var_1265;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_44)
         {
            this.var_44.events.removeEventListener(HabboHelpTutorialEvent.const_422,this.onTaskDoneEvent);
            this.var_44.events.removeEventListener(HabboHelpTutorialEvent.const_491,this.onTaskDoneEvent);
            this.var_44.events.removeEventListener(HabboHelpTutorialEvent.const_440,this.onTaskDoneEvent);
            this.var_44 = null;
         }
      }
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_422:
               this.var_1265 = true;
               if(this.var_38 != null && this.var_38.id == const_465)
               {
                  this.showView(const_86);
               }
               break;
            case HabboHelpTutorialEvent.const_491:
               if(this.var_38 != null && this.var_38.id == const_361)
               {
                  this.var_1579 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_440:
               if(this.var_1579)
               {
                  this.var_1579 = false;
                  this.showView(const_86);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_1595 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_356:
               ...
               if(this.var_306 == null)
               {
                  this.var_306 = new NameChangeView(this);
               }
               this.var_306.showMainView();
               this.prepareForTutorial();
               break;
            case const_361:
         ...
         this._window.height = _loc2_.height + this.var_1596;
         this._window.width = _loc2_.width + this.var_1595;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function prepareForTutorial() : void
      {
         ...
         this.var_44.hideUI();
         this.var_44.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_114));
      }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_38 != null && (this.var_38.id == const_356 || this.var_38.id == const_86))
         {
            this.showView(const_86);
         }
      }
      ...
      {
         this.var_1264 = true;
         if(this.var_38 != null && (this.var_38.id == const_361 || this.var_38.id == const_86))
         {
            this.showView(const_86);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_306.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_499)
         {
            this.var_306.checkedName = _loc2_.name;
         }
         else
         {
            this.var_306.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
