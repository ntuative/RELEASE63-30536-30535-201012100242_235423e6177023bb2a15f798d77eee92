package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1193:uint = 13232628;
      
      private static var var_1451:uint = 11129827;
      ...
      private var var_950:NameSuggestionListRenderer;
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1450 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_631)
         {
            this.var_631 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_631)
            {
               return;
            }
            this._window.content.addChild(this.var_631);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_632)
         {
            this.var_632 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_632)
            {
               return;
            }
            this._window.content.addChild(this.var_632);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_632.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_419;
         }
         this.showView(this.var_632);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_419);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_921 || param1 == ChangeUserNameResultMessageEvent.var_922)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_950 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_950.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1193;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_419 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "select_name_button":
               ...
               if(this.var_419 != _loc5_)
               {
                  this.var_1449 = _loc5_;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_419);
               break;
