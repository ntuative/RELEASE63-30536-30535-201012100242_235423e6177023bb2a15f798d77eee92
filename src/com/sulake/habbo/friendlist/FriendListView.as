package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private var var_1340:FriendListTabsView;
      ...
      private var var_1341:ITextWindow;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_1340 = new FriendListTabsView(this._friendList);
      }
      ...
      private function prepare() : void
      {
         ...
         this.var_845 = IWindowContainer(this.var_17.content.findChildByName("main_content"));
         this.var_251 = IWindowContainer(this.var_17.content.findChildByName("footer"));
         this.var_1340.prepare(this.var_845);
         this.var_17.procedure = this.onWindow;
         this.var_17.content.setParamFlag(HabboWindowParam.const_983,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_994,true);
         this.var_17.header.setParamFlag(HabboWindowParam.const_819,false);
         this.var_17.header.setParamFlag(HabboWindowParam.const_609,true);
         this.var_17.content.setParamFlag(HabboWindowParam.const_819,false);
         this.var_17.content.setParamFlag(HabboWindowParam.const_609,true);
         this.var_17.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1341 = ITextWindow(this.var_17.findChildByName("info_text"));
         this.var_1341.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1723 == -1 ? 0 : int(this.var_17.height - this.var_1723);
         var _loc4_:int = this.var_1725 == -1 ? 0 : int(this.var_17.width - this.var_1725);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_998,this._friendList.tabs.findSelectedTab() != null);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_819,false);
         this.var_17.scaler.setParamFlag(HabboWindowParam.const_983,false);
         ...
         this.var_1723 = this.var_17.height;
         this.var_1725 = this.var_17.width;
