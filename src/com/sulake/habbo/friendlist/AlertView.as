package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1203:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1203[this.var_1204]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var_1203[this.var_1204] = this._alert;
      }
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(this._friendList.getXmlWindow(this.var_1204));
