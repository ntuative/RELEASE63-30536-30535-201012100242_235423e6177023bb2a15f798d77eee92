package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_746:String = "bg";
      ...
      private var var_2161:IContainerButtonWindow;
      ...
      private var var_359:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_359 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2164 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2161 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2162 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2163 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_746);
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_746);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2164,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2161,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2162,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2163,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_359.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_359.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_359.closePopup();
         }
