package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1543:String = "no_reqs_info";
      ...
      {
         this.var_1508 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1507 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1507.procedure = this.onDismissAllButtonClick;
         this.var_1508.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_946)
         {
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_368 && _loc4_.state != FriendRequest.const_347)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1508,_loc1_);
         this.setEnabled(this.var_1507,_loc1_);
      }
