package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1794:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_827 = param1.gender;
         this.var_696 = param1.online;
         this.var_1454 = param1.followingAllowed && param1.online;
         this.var_562 = param1.figure;
         this.var_1632 = param1.motto;
         this.var_1634 = param1.lastAccess;
         this.var_1363 = param1.categoryId;
         this.var_1633 = param1.realName;
