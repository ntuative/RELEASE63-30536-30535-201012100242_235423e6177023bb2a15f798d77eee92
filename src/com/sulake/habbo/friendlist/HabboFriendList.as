package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_2271:FriendListLookAndFeel;
      
      private var var_351:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1652:OpenedToWebPopup;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1050)
         {
            this.var_1050.release(new IIDAvatarRenderManager());
            this.var_1050 = null;
         }
         if(this.var_791)
         {
            this.var_791.release(new IIDHabboNotifications());
            this.var_791 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_691)
         {
            this.var_691.release(new IIDSessionDataManager());
            this.var_691 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1652 = new OpenedToWebPopup(this);
         }
         this.var_1652.show(x,y);
      }
      ...
      {
         var _loc2_:IAvatarImage = this.var_1050.createAvatarImage(param1,AvatarScaleType.const_83,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_154.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_154.getKey(param1,param1,param2);
      }
      ...
      {
         this.var_791 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_889,this.getText("friendlist.friends")));
         this.var_91.addCategory(new FriendCategory(FriendCategory.const_357,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_91.addFriend(new Friend(_loc4_));
         }
         this.var_351 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_572)
         {
         ...
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_102,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_91.findCategory(FriendCategory.const_357);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_351.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_379));
            }
            else
            {
               switch(_loc1_.id)
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_351.findTab(FriendListTab.const_94).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_351.findTab(FriendListTab.const_94);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1651.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_351.findTab(FriendListTab.const_94);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_691 || !this.var_319)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_691.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_319.vipLimit;
         }
         else if(this.var_691.hasUserRight("fuse_extended_buddylist"))
         {
