package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      {
         this.var_267 = param2 as IHabboCommunicationManager;
         if(this.var_267 == null)
         {
            return;
         }
         this._connection = this.var_267.getHabboMainConnection(this.onConnectionReady);
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2447 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2450 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2448 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1768 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1768 > 0 && this.var_1767 >= this.var_1768)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1097;
         if(_loc1_ > this.var_2450)
         {
            ++this.var_1767;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1362 = _loc2_.imageUrl;
         this.var_2449 = _loc2_.clickUrl;
         this.var_1097 = getTimer();
         if(this.var_1362 != "")
         {
            _loc3_ = this.var_1362;
            ...
            {
               this.var_207 = new Timer(this.var_2448,1);
            ...
            this.var_207.start();
            _loc4_ = new URLRequest(this.var_1362);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_437,0,0,param1.bitmapData,this.var_2449));
            this.var_1097 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_394));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1766 = _loc2_.clickUrl;
         if(this.var_1361 != "" && this.var_1766 != "")
         {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_507,0,0,_loc4_,this.var_1766,this.var_1096,this.var_1095));
         }
      }
