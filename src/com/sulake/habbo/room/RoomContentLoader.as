package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_1215:String = const_391;
      
      private static const ROOM_CONTENT:String = "room";
      
      private static const const_868:String = "tile_cursor";
      
      private static const const_869:String = "selection_arrow";
      ...
      private var var_1335:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         this.var_589 = [];
         this._wallItems = [];
         this.var_2339 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2344 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_870)
         {
            return;
         }
         this.var_1335 = param1;
         this.var_2342 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2340 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2341 = param2.getKey("public.room.dynamic.download.url","");
         this.var_2343 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_473.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_473.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc2_.type == "s")
            {
               ...
               if(this.var_589.indexOf(_loc7_) < 0)
               {
                  this.var_589.push(_loc7_);
               }
            }
            ...
            _loc8_ = this.var_588.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_588.remove(_loc7_);
               this.var_588.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2345)
         {
            ...
            {
               this.var_1335.dispatchEvent(new Event(const_709));
            }
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_589.indexOf(param1) >= 0)
         {
      ...
      {
         return [const_391,const_553,ROOM_CONTENT,const_868,const_869];
      }
      ...
      {
         if(this.var_183 != null && this.var_183.hasWorldType(const_310 + param1))
         {
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_180 || param1 == RoomObjectVisualizationEnum.const_65 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_588.getValue(param1));
         }
         return 0;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_2343;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_2341 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                     if(this.var_589.indexOf(_loc4_) == -1)
                     {
                        this.var_589.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            this.var_183 = this.var_1334.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_715,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2339.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1268);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2344.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1334.add(_loc5_,_loc8_);
               this.var_183 = _loc8_;
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_414,_loc5_);
         }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_473.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_473.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_473.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_233 && _loc5_ != RoomObjectLogicEnum.const_180)
         {
            _loc6_ = "@shadow";
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_183.getWorldHeightScale(const_310 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_183 != null)
         {
            return this.var_183.getWorldScale(const_310 + param1);
         }
         return 32;
      }
