package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_597,param1,param2,param3,param4));
         }
      }
      ...
      public function processRoomCanvasMouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomObject, param3:IRoomGeometry) : void
      {
         ...
         if(param2.method_5() != null)
         {
            param2.method_5().mouseEvent(param1,param3);
         }
      }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_179:
               this.handleObjectStateChange(param1 as RoomObjectStateChangeEvent,param2,param3);
               break;
            case RoomObjectStateChangeEvent.const_595:
            ...
            case RoomObjectDimmerStateUpdateEvent.const_60:
               ...
               break;
            case RoomObjectMoveEvent.const_534:
            ...
            case RoomObjectRoomActionEvent.const_1013:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            case RoomObjectMouseEvent.const_218:
               ...
               break;
            case RoomObjectMouseEvent.const_485:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_74)
         {
            ...
            if(_loc14_ != _loc10_ && _loc15_ != _loc10_)
            {
               ...
               if(_loc16_ != null)
               {
                  _loc16_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_412,param2,param3,-1,RoomObjectCategoryEnum.const_149));
               }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc8_ == RoomObjectCategoryEnum.const_27)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_576,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.ROOM_OBJECT_SOUND_MACHINE_START:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_467:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_648));
               break;
            case RoomObjectFurnitureActionEvent.const_533:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_527));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_508:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_775));
               break;
            case RoomObjectFurnitureActionEvent.const_428:
               this._roomEngine.events.dispatchEvent(new RoomObjectSoundMachineStateUpdateEvent(param1.objectId,param1.objectType,RoomObjectSoundMachineStateUpdateEvent.const_527));
         }
      ...
      private function validateFurnitureLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:TileHeightMap) : Vector3d
      {
         ...
         var _loc8_:int = param1.getModel().getNumber(RoomObjectVariableEnum.const_345);
         if(_loc7_ < 1)
         {
            _loc7_ = 1;
         }
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_764);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_278,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var category:int = 0;
         var object:IRoomObjectController = this._roomEngine.getRoomObject(roomId,roomCategory,this.var_1271,category) as IRoomObjectController;
