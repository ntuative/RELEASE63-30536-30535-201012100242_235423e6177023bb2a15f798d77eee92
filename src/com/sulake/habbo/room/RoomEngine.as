package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_557:String = "temporary_room";
      
      private static const const_311:int = -1;
      
      private static const const_558:String = "room";
      
      private static const const_881:int = -2;
      
      private static const const_1227:String = "tile_cursor";
      
      private static const const_880:int = -3;
      
      private static const const_1226:String = "selection_arrow";
      
      private static const const_879:String = "overlay";
      ...
      private var var_724:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_724 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_334 != null)
         {
            ...
            {
               _loc2_ = this.var_334.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_334.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_334.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc3_ = this.var_334.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  ...
                  if(_loc5_ != this.var_96 || _loc6_ != this.var_97 || !this.var_1100)
                  {
      ...
      private function updateRoomCamera(param1:int, param2:int, param3:int, param4:Vector3d, param5:uint) : void
      {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc13_ != null)
            {
               _loc14_ = _loc10_.getNumber(RoomVariableEnum.const_665) - 0.5;
               _loc15_ = _loc10_.getNumber(RoomVariableEnum.const_807) - 0.5;
               _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_794) + 0.5;
               _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_727) + 0.5;
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_42 != null)
         {
            ...
            this.var_42.addObjectUpdateCategory(RoomObjectCategoryEnum.const_264);
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_15 != null)
         {
            events.addEventListener(RoomContentLoader.const_709,this.onContentLoaderReady);
      ...
      {
         if(param1 != null && param1.type == RoomContentLoader.const_709)
         {
            this.var_2458 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_263.events.addEventListener(AdEvent.const_507,this.showRoomAd);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.sessionDataManager = this.var_404;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_24 != null)
         {
            ...
            {
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_218,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_485,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMouseEvent.const_454,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectStateChangeEvent.const_179,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectStateChangeEvent.const_595,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectWidgetRequestEvent.const_97,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_493,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectFurnitureActionEvent.const_467,this.roomObjectEventHandler);
               ...
               this.var_24.events.addEventListener(RoomObjectMoveEvent.const_534,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectMoveEvent.const_458,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_260,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_407,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_362,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomAdEvent.const_317,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_482,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_1013,this.roomObjectEventHandler);
               this.var_24.events.addEventListener(RoomObjectRoomActionEvent.const_472,this.roomObjectEventHandler);
            }
         }
      }
      ...
      {
         if(this.var_24 == null || this.var_453 == null || this.var_42 == null || this.var_896 == null || this._communication == null || this.var_125 == null || !this.var_2458)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_487 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_711,0,0));
            _loc2_ = 0;
            while(_loc2_ < this.var_335.length)
            {
               _loc3_ = this.var_335.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_974,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_400,param1,param2));
            }
            else
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_464,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_974);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_487)
         {
            _loc5_ = this.var_335.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_335.add(_loc4_,_loc5_);
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_901,param6,true);
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_943,_loc13_,true);
            if(this.var_15 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_311,const_558,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_571,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_679,_loc10_,true);
         if(param2 != null)
         {
            _loc14_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_665,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_794,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_807,_loc18_);
               _loc7_.setNumber(RoomVariableEnum.const_727,_loc19_);
         ...
         if(param3 != null)
         {
            _loc11_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_671,param3);
            ...
            if(param2.doors.door.length() > 0)
            {
               ...
               while(_loc23_ < _loc20_.length())
               {
                  ...
                  if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                  {
                     ...
                     _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_468,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_222);
                     _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                     if(_loc28_ == 90 || _loc28_ == 180)
                     {
                        if(_loc28_ == 90)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_606,_loc25_ - 0.5,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_712,_loc26_,true);
                        }
                        if(_loc28_ == 180)
                        {
                           _loc7_.setNumber(RoomObjectVariableEnum.const_606,_loc25_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_712,_loc26_ - 0.5,true);
                        }
                        _loc7_.setNumber(RoomObjectVariableEnum.const_1063,_loc27_,true);
                        _loc7_.setNumber(RoomObjectVariableEnum.const_949,_loc28_,true);
                     }
                  }
                  _loc23_++;
               }
         ...
         _loc7_.createRoomObject(const_881,const_1227,RoomObjectCategoryEnum.const_264);
         _loc7_.createRoomObject(const_880,const_1226,RoomObjectCategoryEnum.const_264);
         return _loc7_;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         ...
         if(_loc6_ == null)
         {
            ...
            _loc9_ = this.var_335.getValue(_loc8_);
            if(_loc9_ == null)
            {
               _loc9_ = new RoomData(param1,param2,null);
               this.var_335.add(_loc8_,_loc9_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            _loc7_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_671,param3);
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1344,param3,param4,param5);
         _loc6_.getEventHandler().processUpdateMessage(_loc7_);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1032,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_932,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_334.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_743,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_679);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_606);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_712);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1063);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_949);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1100 = true;
               this.var_895 = false;
               this.var_2460 = this.var_1365;
               this.var_2459 = this.var_1366;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1100)
            {
               if(!this.var_895)
               {
                  _loc8_ = param2 - this.var_2460;
                  _loc9_ = param3 - this.var_2459;
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_412,this.var_96,this.var_97,-1,RoomObjectCategoryEnum.const_149));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_70 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_311,const_558);
      ...
      private function getOverlaySprite(param1:IRoomRenderingCanvas) : Sprite
      {
         ...
         return _loc2_.getChildByName(const_879) as Sprite;
      }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc7_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_96,this.var_97,this.var_1364);
         if(_loc7_ != null)
         {
            ...
            if(_loc11_ != null)
            {
               _loc11_.x = this.var_1365 - _loc6_.data.width / 2;
               _loc11_.y = this.var_1366 - _loc6_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_96,this.var_97,this.var_1364);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_96,this.var_97,this.var_1364);
         if(_loc1_ != null)
         {
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_880,RoomObjectCategoryEnum.const_264);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_881,RoomObjectCategoryEnum.const_264);
      }
      ...
      public function addObjectFurniture(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String, param9:Number = NaN, param10:int = -1) : Boolean
      {
         ...
         if(_loc14_ != null && _loc14_.getModelController() != null)
         {
            ...
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_378,param4,true);
            _loc14_.getModelController().setString(RoomObjectVariableEnum.const_350,_loc13_,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1098,1,true);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1047,param10);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_913,getTimer());
         }
      ...
      public function addObjectWallItem(param1:int, param2:int, param3:int, param4:int, param5:IVector3d, param6:IVector3d, param7:int, param8:String) : Boolean
      {
         ...
         if(_loc12_ != null && _loc12_.getModelController() != null)
         {
            ...
            _loc12_.getModelController().setNumber(RoomObjectVariableEnum.const_378,param4,true);
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_940) > 0)
               {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_599,this.var_96,this.var_97,param2,param3));
            }
         }
      }
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:String = null, param7:uint = 0, param8:String = null) : ImageResult
      {
         ...
         _loc9_.id = -1;
         if(!this.var_487 || param1 == null)
         {
            return _loc9_;
         }
         var _loc10_:IRoomInstance = this.var_42.getRoom(const_557);
         if(_loc10_ == null)
         {
            _loc10_ = this.var_42.createRoom(const_557,null);
            if(_loc10_ == null)
            {
               return _loc9_;
            }
         }
         var _loc11_:int = this.var_724.reserveNumber();
         ...
         switch(_loc12_)
         {
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
            case RoomObjectCategoryEnum.const_27:
               _loc13_.getModelController().setNumber(RoomObjectVariableEnum.const_252,int(param2));
            ...
            case RoomObjectCategoryEnum.const_74:
               if(param2 != null)
               {
                  ...
                  if(_loc17_.length >= 3)
                  {
                     ...
                     _loc21_.addPlane(RoomPlaneData.const_303,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
                     ...
                     if(param6 != null)
                     {
                        ...
                        _loc23_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_468,_loc24_,param6,new Vector3d(2,0,1.75));
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this.var_42.getRoom(const_557);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               this.var_724.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1099.remove(String(_loc10_)) as IGetImageListener;
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_373,param1.image,true);
            ...
            this.var_15.addGraphicAsset(this.var_15.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_927,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_922,RoomObjectVariableEnum.const_373,param1.clickUrl);
