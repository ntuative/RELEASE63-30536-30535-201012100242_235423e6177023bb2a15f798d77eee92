   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1 is RoomObjectAvatarPetGestureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_305,_loc6_.gesture);
         ...
         if(param1 is RoomObjectAvatarSleepUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_397,Number(_loc8_.isSleeping));
            return;
         }
         ...
         if(param1 is RoomObjectAvatarExperienceUpdateMessage)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_1023,Number(getTimer()));
            _loc2_.setNumber(RoomObjectVariableEnum.const_985,Number(_loc10_.gainedExperience));
            return;
         }
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1485,_loc11_.race);
            return;
         }
      }
      ...
      private function updateActions(param1:int, param2:IRoomObjectModelController) : void
      {
         ...
         {
            param2.setString(RoomObjectVariableEnum.const_305,null);
            this.var_1260 = 0;
         }
         if(this.var_1259 > 0)
         {
