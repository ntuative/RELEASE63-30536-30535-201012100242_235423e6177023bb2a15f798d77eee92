   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2233 = param1.extra;
            this.var_1038 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1038 > 0 && param1 >= this.var_1038)
         {
            this.var_1038 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1549,String(this.var_1549),this.var_2233);
