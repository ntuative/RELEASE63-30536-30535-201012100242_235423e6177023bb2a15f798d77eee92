   ...
   public class FurnitureClothingChangeLogic extends FurnitureLogic
   {
      ...
      private function updateClothingData(param1:String) : void
      {
         ...
         if(param1 != null && param1.length > 0)
         {
            ...
            if(_loc2_.length > 0)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_962,_loc2_[0]);
            }
            if(_loc2_.length > 1)
            {
               object.getModelController().setString(RoomObjectVariableEnum.const_1050,_loc2_[1]);
            }
         }
      }
