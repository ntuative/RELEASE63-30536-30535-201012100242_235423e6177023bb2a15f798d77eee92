package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurniturePushableLogic extends FurnitureMultiStateLogic
   {
      ...
      private static const const_867:int = 0;
      ...
      override public function update(param1:int) : void
      {
         if(object != null)
         {
            this.var_1691.assign(object.getLocation());
            super.update(param1);
            if(Vector3d.dif(object.getLocation(),this.var_1691).length == 0)
            {
               if(object.getState(0) != const_867)
               {
                  object.setState(const_867,0);
               }
            }
         }
      }
