package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1352:uint = 16777215;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_670,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_579,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_603,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_578,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1086)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1554;
            if(_loc2_ - this.var_1086 >= this.var_1744)
            {
               _loc3_ = this.var_1085;
               _loc4_ = this.var_1746;
               this.var_1086 = 0;
            }
            else
            {
               _loc7_ = this.var_1352 >> 16 & 255;
               _loc8_ = this.var_1352 >> 8 & 255;
               _loc9_ = this.var_1352 & 255;
               _loc10_ = this.var_1085 >> 16 & 255;
               _loc11_ = this.var_1085 >> 8 & 255;
               _loc12_ = this.var_1085 & 255;
               _loc13_ = (_loc2_ - this.var_1086) / this.var_1744;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1745 + (this.var_1746 - this.var_1745) * _loc13_;
               this._color = _loc3_;
               this.var_1554 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_670,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_629:
               param2.setString(RoomObjectVariableEnum.const_735,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_468:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_222)
               {
                  _loc5_ = "null";
               }
               this.var_450.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_654:
               _loc4_ = this.var_450.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_450.getXML();
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_932:
               param2.setNumber(RoomObjectVariableEnum.const_579,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1032:
               param2.setNumber(RoomObjectVariableEnum.const_603,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_578,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_895,int(param1.bgOnly));
         this.var_1352 = this._color;
         this.var_1745 = this.var_1554;
         this.var_1085 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_418,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1271,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1399,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1472,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_418,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_143 || _loc13_ == RoomPlaneData.const_303)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
