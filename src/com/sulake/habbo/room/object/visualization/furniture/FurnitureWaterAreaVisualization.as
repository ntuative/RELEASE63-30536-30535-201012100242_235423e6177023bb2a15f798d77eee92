package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1193:String = "shore";
      ...
      {
         if(this.var_2166 == param1 && this.var_2165 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(_loc2_,_direction,param1) == const_1193)
            {
               this.var_1573 = _loc2_;
               this.var_2166 = param1;
               this.var_2165 = _direction;
               return this.var_1573;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1012.indexOf(_loc2_) < 0)
            {
      ...
      {
         var _loc2_:* = null;
         if(this.var_448 == 0 || this.var_559 == 0)
         {
            ...
            this.var_448 = _loc2_.getNumber(RoomObjectVariableEnum.const_268);
            this.var_559 = _loc2_.getNumber(RoomObjectVariableEnum.const_345);
         }
         this.var_370 = [];
         this.var_558 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_448 * 2 + this.var_559 * 2)
         {
            this.var_370.push(false);
            this.var_558.push(ShoreMaskCreatorUtility.const_67);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_66,getSize(param3),this.var_370,this.var_558,assetCollection);
      }
