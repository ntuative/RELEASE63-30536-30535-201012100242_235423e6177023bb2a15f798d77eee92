package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlane
   {
      ...
      private var var_685:Vector3d = null;
      ...
      public function FurniturePlane(param1:IVector3d, param2:IVector3d, param3:IVector3d)
      {
         ...
         this.var_685 = new Vector3d();
         this.var_685.assign(param2);
         this.var_684 = new Vector3d();
         this.var_684.assign(param3);
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != this.var_2252)
         {
            if(!param1)
            {
               this.var_271.assign(this.var_685);
               this.var_272.assign(this.var_684);
            }
            else
            {
               this.var_271.assign(this.var_685);
               this.var_271.mul(this.var_684.length / this.var_685.length);
               this.var_272.assign(this.var_684);
               this.var_272.mul(this.var_685.length / this.var_684.length);
            }
            this.var_1640 = -1;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || this.var_76 == null && this.var_1044 != null || this.var_271 == null || this.var_272 == null || this.var_569 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != this.var_1640)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != this.var_1295 || _loc4_.y != this.var_2185 || _loc4_.z != this.var_2183 || param1.scale != this.var_2184))
            {
               this.var_1295 = _loc4_.x;
               this.var_2185 = _loc4_.y;
               this.var_2183 = _loc4_.z;
               ...
               _loc6_ = param1.getScreenPosition(this.var_1044);
               _loc7_ = _loc6_.z;
               _loc8_ = Math.max(this.var_139.z - _loc7_,this.var_106.z - _loc7_,this.var_82.z - _loc7_,this.var_107.z - _loc7_);
               this.var_2253 = _loc8_;
