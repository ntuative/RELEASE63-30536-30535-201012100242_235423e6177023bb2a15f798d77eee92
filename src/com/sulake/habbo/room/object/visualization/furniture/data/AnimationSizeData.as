   ...
   public class AnimationSizeData extends SizeData
   {
      ...
      public function defineAnimations(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            this.var_301.add(_loc7_,_loc8_);
            _loc5_++;
         }
         return true;
      }
      ...
      {
         var _loc2_:AnimationData = this.var_301.getValue(param1) as AnimationData;
         if(_loc2_ != null)
         {
      ...
      {
         var _loc5_:* = null;
         var _loc4_:AnimationData = this.var_301.getValue(param2) as AnimationData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc7_:* = null;
         var _loc6_:AnimationData = this.var_301.getValue(param2) as AnimationData;
         if(_loc6_ != null)
         {
