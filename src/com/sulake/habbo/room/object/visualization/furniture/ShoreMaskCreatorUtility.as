package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class ShoreMaskCreatorUtility
   {
      ...
      private static const const_1251:int = 3;
      ...
      {
         return param1 + param2 * const_1251;
      }
            ...
            if(param2.getAsset(_loc4_) == null)
            {
               if(param3 != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = [const_136,const_67,const_62,const_136,const_67,const_62];
                     _loc8_ = [const_67,const_67,const_67,const_62,const_62,const_62];
                     _loc9_ = null;
                     _loc10_ = 0;
                     if(_loc6_ != null)
                     {
