package com.sulake.habbo.room.object.visualization.furniture.data
{
   public class AnimationLayerData
   {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_198[_loc1_] as AnimationFrameSequenceData;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function calculateLength() : void
      {
         ...
         while(_loc1_ < this.var_198.length)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_375 += _loc2_.frameCount;
            }
            _loc1_++;
         }
      }
      ...
      public function getFrame(param1:int) : AnimationFrame
      {
         ...
         var _loc2_:* = null;
         param1 /= this.var_1610;
         var _loc3_:Boolean = false;
         if(!this.var_1609)
         {
            _loc4_ = param1 / this.var_375;
            param1 %= this.var_375;
            if(this._loopCount > 0 && _loc4_ >= this._loopCount || this._loopCount <= 0 && this.var_375 == 1)
            {
               param1 = this.var_375 - 1;
               _loc3_ = true;
            }
            _loc5_ = 0;
            _loc6_ = 0;
            _loc6_ = 0;
            while(_loc6_ < this.var_198.length)
            {
               _loc2_ = this.var_198[_loc6_] as AnimationFrameSequenceData;
               if(_loc2_ != null)
               {
         ...
         _loc7_ = this.var_198.length * Math.random();
         _loc2_ = this.var_198[_loc7_] as AnimationFrameSequenceData;
      ...
      public function getFrameFromSequence(param1:int, param2:int, param3:int) : AnimationFrame
      {
         ...
         var _loc4_:AnimationFrameSequenceData = this.var_198[param1] as AnimationFrameSequenceData;
         if(_loc4_ != null)
         {
      ...
      private function getFrameFromSpecificSequence(param1:int, param2:AnimationFrameSequenceData, param3:Boolean, param4:int) : AnimationFrame
      {
         ...
         if(param2 != null)
         {
            ...
            _loc9_ = this.var_1610 * _loc8_;
            if(param3)
            {
               _loc9_ = 0;
            }
            _loc10_ = false;
            if(!this.var_1609 && !param2.isRandom)
            {
               if(param4 == this.var_198.length - 1 && param1 == param2.frameCount - 1)
               {
                  _loc10_ = true;
               }
            }
