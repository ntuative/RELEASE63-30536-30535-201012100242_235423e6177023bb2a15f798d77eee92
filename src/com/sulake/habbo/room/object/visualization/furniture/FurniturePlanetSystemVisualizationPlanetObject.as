package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1203:Number = 30;
      ...
      private var var_1646:Number;
      
      private var _height:Number;
      
      private var var_1046:Number;
      
      private var var_688:Vector3d;
      ...
      {
         this.var_688 = new Vector3d(0,0,0);
         this._children = new Array();
         super();
         this._name = param1;
         this._index = param2;
         this.var_1207 = param3;
         this.var_2261 = param4 * 0 * 2 / 360;
         this.var_1646 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_1046 = 0;
      }
      ...
      {
         var _loc3_:Number = this.var_1207 * Math.cos(this.var_1046 + this.var_1646);
         var _loc4_:Number = this.var_1207 * Math.sin(this.var_1046 + this.var_1646);
         var _loc5_:Number = this._height;
         this.var_688.x = (_loc3_ - _loc4_) * (param2 / 2);
         this.var_688.y = (_loc4_ + _loc3_) * (param2 / 2) * 0.5 - this._height * (param2 / 2);
         this.var_688.z = -int(4 * (_loc3_ + _loc4_) - 0.7);
         if(param1 != null)
         {
            this.var_688.add(param1);
         }
         return this.var_688;
      }
