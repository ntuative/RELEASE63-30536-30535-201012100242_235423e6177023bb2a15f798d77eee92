package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2608:Number = NaN;
      
      protected var var_2609:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1166:String = null;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1562 != spriteCount)
         {
            createSprites(this.var_1562);
         }
         var _loc4_:Boolean = false;
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param1 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,this.var_2609,param2);
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_406 != _loc3_.getUpdateID() || param1 != var_252 || param2 != this.var_2608)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2609 = _loc3_.getNumber(RoomObjectVariableEnum.const_252);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_278));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1166 = _loc3_.getString(RoomObjectVariableEnum.const_350);
            if(this.var_1166 == null || this.var_1166.indexOf("http") != 0)
            {
               this.var_1166 = null;
            }
      ...
      {
         if(this.var_2318 != param1 || this.var_2319 != param2)
         {
            this.var_859 = [];
            this.var_858 = [];
            this.var_705 = [];
            ...
            this.var_1562 = this._data.getLayerCount(param2) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:Number) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param1 >= FurnitureVisualizationData.const_1109.length)
         {
            return "";
         }
         var _loc3_:String = this.var_859[param1];
         var _loc4_:Boolean = this.var_858[param1];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param1 < spriteCount - 1)
            {
               ...
               _loc6_ = FurnitureVisualizationData.const_1109[param1];
            }
            else
            {
               _loc6_ = "sd";
      ...
      {
         if(this.var_700[param1] != null && !this.var_1688)
         {
      ...
      {
         if(this.var_704[param1] != null)
         {
            return this.var_704[param1];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         this.var_702[param1] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteMouseCapture(param1:int, param2:int, param3:int) : Boolean
      {
         if(this.var_703[param1] != null)
         {
