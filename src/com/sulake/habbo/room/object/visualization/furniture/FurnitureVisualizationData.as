package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      public static const const_1109:Array = new Array("a","b","c","d","e","f","g","h","i","j","k","l","m","n","o","p","q","r","s","t","u","v","w","x","y","z");
      ...
      public function dispose() : void
      {
         ...
         if(this.var_277 != null)
         {
            ...
            {
               _loc1_ = this.var_277.getWithIndex(_loc2_) as SizeData;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      protected function defineVisualizations(param1:XML) : Boolean
      {
         ...
         while(_loc4_ < _loc2_.length())
         {
            ...
            if(this.var_277.getValue(String(_loc6_)) != null)
            {
               return false;
            }
            ...
            this.var_277.add(String(_loc6_),_loc9_);
      ...
      protected function getSizeData(param1:int) : SizeData
      {
         ...
         if(_loc2_ < this._sizes.length)
         {
            this.var_860 = this.var_277.getValue(String(this._sizes[_loc2_])) as SizeData;
         }
         else
         {
            this.var_860 = null;
