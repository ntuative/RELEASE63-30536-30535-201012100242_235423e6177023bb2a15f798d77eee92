package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      private var var_444:AnimatedFurnitureVisualizationData = null;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         this.var_444 = param1 as AnimatedFurnitureVisualizationData;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_622);
                  this.var_1560 = _loc6_;
               }
            }
            return true;
         }
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_622);
                     if(_loc4_ > this.var_1560)
                     {
      ...
      private function resetAnimationFrames() : void
      {
         ...
         this.var_1000 = false;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1562)
         {
            this.var_445[_loc1_] = null;
      ...
      {
         if(this.var_444 != null && this._state >= 0)
         {
            if(this.var_444.hasAnimation(AnimationData.getTransitionAnimationId(param1),this.var_1561))
            {
               if(this.var_1001 != AnimationData.getTransitionAnimationId(param1))
               {
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(param1 != this.var_1561)
         {
            this.var_1562 = this.var_444.getLayerCount(param1);
            this.resetAnimationFrames();
         }
         var _loc2_:Array = this.updateAnimationFrames(param1);
         if(this.var_1000 && _loc2_ != null && AnimationData.isTransitionAnimation(this.var_1001))
         {
            this.setAnimation(AnimationData.getAnimationId(this.var_1001));
      ...
      private function updateAnimationFrames(param1:Number) : Array
      {
         ...
         if(this.var_547 == 0)
         {
            this.var_547 = this.var_444.getStartFrame(this.animationId,param1);
         }
         this.var_547 += 1;
         var _loc3_:* = null;
         this.var_1000 = true;
         var _loc4_:int = this.var_1562 - 1;
         while(_loc4_ >= 0)
         {
            ...
            if(!_loc5_)
            {
               ...
               _loc7_ = this.var_445[_loc4_] as AnimationFrame;
               if(_loc7_ != null)
               {
               ...
               if(_loc7_ == null || _loc7_.remainingFrameRepeats >= 0 && _loc9_ <= 0)
               {
                  ...
                  if(_loc8_ == AnimationFrame.const_1093)
                  {
                     _loc7_ = this.var_444.getFrame(_loc4_,this.animationId,this.var_547,param1);
                  }
                  else
                  {
                     _loc7_ = this.var_444.getFrameFromSequence(_loc4_,this.animationId,_loc8_,_loc7_.activeSequenceOffset + _loc7_.repeats,this.var_547,param1);
                  }
                  this.var_445[_loc4_] = _loc7_;
                  if(_loc3_ != null)
                  {
                     _loc3_.push(_loc4_);
                  }
      ...
      {
         var _loc3_:AnimationFrame = this.var_445[param1] as AnimationFrame;
         if(_loc3_ != null)
         {
            return _loc3_.id;
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         var _loc5_:AnimationFrame = this.var_445[param1] as AnimationFrame;
         if(_loc5_ != null)
         {
            _loc4_ += _loc5_.x;
         }
