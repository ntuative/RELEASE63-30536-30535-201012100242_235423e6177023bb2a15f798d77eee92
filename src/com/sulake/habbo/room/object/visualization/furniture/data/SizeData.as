package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_360:int = 1000;
      ...
      private var var_1217:int = 360;
      
      private var var_649:DirectionData = null;
      
      private var var_225:Map;
      
      private var _colors:Map;
      
      private var var_972:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_649 = new DirectionData(param1);
      ...
      public function dispose() : void
      {
         ...
         if(this.var_225 != null)
         {
            ...
            {
               _loc2_ = this.var_225.getWithIndex(_loc1_) as DirectionData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_649,_loc3_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc8_ = _loc6_.layer;
            if(this.var_225.getValue(String(_loc7_)) != null)
            {
               return false;
            }
            _loc3_ = new DirectionData(this.layerCount);
            _loc3_.copyValues(this.var_649);
            this.defineDirection(_loc3_,_loc8_);
            this.var_225.add(String(_loc7_),_loc3_);
            this.var_1487 = -1;
            this.var_972 = null;
            _loc5_++;
         }
         ...
         },_loc5_++)
         {
            ...
            switch(String(_loc4_))
            {
               case "ADD":
                  ...
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_1097);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1217 / 2) % 360 / this.var_1217;
         if(this.var_225.getValue(String(_loc2_)) != null)
         {
            return _loc2_;
         }
         ...
         {
            _loc6_ = int(this.var_225.getKey(_loc5_)) * this.var_1217;
         ...
         if(_loc4_ >= 0)
         {
            return int(this.var_225.getKey(_loc4_));
         }
         return const_1333;
      }
      ...
      private function getDirectionData(param1:int) : DirectionData
      {
         ...
         var _loc2_:* = null;
         _loc2_ = this.var_225.getValue(String(param1)) as DirectionData;
         if(_loc2_ == null)
         {
            _loc2_ = this.var_649;
         }
