package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1044:Vector3d = null;
      ...
      private var var_871:IPlaneRasterizer = null;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_569 = Vector3d.crossProduct(this.var_271,this.var_272);
         if(this.var_569.length > 0)
         {
            this.var_569.mul(1 / this.var_569.length);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
         ...
         this.var_2355 = param10;
         this.var_2351 = param11;
         this.var_2352 = param12;
         this.var_869 = param6;
      }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_871.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_711 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_330))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            _loc7_ = param1.getCoordinatePosition(this.var_569);
            _loc4_ = this.getTextureIdentifier(param1.scale);
            ...
            if(this.var_871 != null)
            {
               _loc3_ = this.var_871.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1710,this.var_2354,this.var_2355,this.var_2351,this.var_2352,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(geometryChanged)
         {
            ...
            originPos = geometry.getScreenPosition(this.var_1044);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_139.z - originZ,this.var_106.z - originZ,this.var_82.z - originZ,this.var_107.z - originZ);
            if(this._type == const_93)
            {
               relativeDepth += 0.02;
            }
            this.var_2253 = relativeDepth;
         ...
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2353);
      ...
      {
         this.var_139.assign(param1.getScreenPosition(this.var_76));
         this.var_106.assign(param1.getScreenPosition(Vector3d.sum(this.var_76,this.var_272)));
         this.var_82.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(this.var_76,this.var_271),this.var_272)));
         this.var_107.assign(param1.getScreenPosition(Vector3d.sum(this.var_76,this.var_271)));
         this._offset = param1.getScreenPoint(this.var_1044);
         ...
         var _loc2_:Number = Math.min(this.var_139.x,this.var_106.x,this.var_82.x,this.var_107.x);
         var _loc3_:Number = Math.max(this.var_139.x,this.var_106.x,this.var_82.x,this.var_107.x);
         var _loc4_:Number = Math.min(this.var_139.y,this.var_106.y,this.var_82.y,this.var_107.y);
         var _loc5_:Number = Math.max(this.var_139.y,this.var_106.y,this.var_82.y,this.var_107.y);
         _loc3_ -= _loc2_;
      ...
      {
         if(this.var_139 == null || this.var_106 == null || this.var_82 == null || this.var_107 == null || param2 == null || this._bitmapData == null)
         {
            return;
         }
         ...
         if(this._type == const_108 || this._type == const_93)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_108 || this._type == const_93))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(this.var_869)
         {
            _loc5_ = null;
            _loc6_ = 0;
            while(_loc6_ < this.var_331.length)
            {
               _loc5_ = this.var_331[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_240.length == this.var_870.length)
         {
            while(_loc1_ < this.var_240.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_870[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_331.length > this.var_1336.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_869 || this.var_240.length == 0 && this.var_331.length == 0 && !this.var_330 || this.var_644 == null)
         {
            return;
         }
         ...
         if(this.var_330)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(this.var_569);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_240.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_66.width - this.var_66.width * _loc3_.leftSideLoc / this.var_271.length;
                  _loc11_ = this.var_66.height - this.var_66.height * _loc3_.rightSideLoc / this.var_272.length;
                  _loc12_ = _loc3_.type;
                  this.var_644.updateMask(this.var_66,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_870.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_331.length)
            {
               _loc4_ = this.var_331[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_66.width - this.var_66.width * _loc4_.leftSideLoc / this.var_271.length;
                  _loc11_ = this.var_66.height - this.var_66.height * _loc4_.rightSideLoc / this.var_272.length;
                  _loc13_ = this.var_66.width * _loc4_.leftSideLength / this.var_271.length;
                  _loc14_ = this.var_66.height * _loc4_.rightSideLength / this.var_272.length;
                  this.var_66.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1336.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_330 = false;
