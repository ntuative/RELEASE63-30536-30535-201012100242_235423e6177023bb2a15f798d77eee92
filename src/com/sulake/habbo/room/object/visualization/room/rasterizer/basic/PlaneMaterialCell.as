package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_546:PlaneTexture;
      ...
      public function getHeight(param1:IVector3d) : int
      {
         ...
         if(this.var_546 != null)
         {
            _loc2_ = this.var_546.getBitmap(param1);
            if(_loc2_ != null)
            {
         ...
         if(this.var_546 != null)
         {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  _loc3_ = Math.min(this.var_990,this._extraItemOffsets.length);
                  _loc4_ = Math.max(this.var_990,this._extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(this.var_990,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = this._extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = this.var_801[_loc6_ % this.var_801.length] as IGraphicAsset;
