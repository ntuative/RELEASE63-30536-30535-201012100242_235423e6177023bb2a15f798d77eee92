package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1328:int = const_354;
      ...
      public static const const_263:int = const_110;
      ...
      private var var_2268:Number = -1.0;
      
      private var _normalMaxX:Number = 1.0;
      
      private var var_2267:Number = -1.0;
      
      private var var_2269:Number = 1.0;
      ...
      public function clearCache() : void
      {
         ...
         if(this.var_690 != null)
         {
            this.var_690.assign(new Vector3d());
         }
         this.var_571 = 0;
         var _loc1_:int = 0;
         while(_loc1_ < this.var_318.length)
         {
            _loc2_ = this.var_318[_loc1_] as PlaneMaterialCellColumn;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(param1 < 0 || param1 >= this.var_318.length)
         {
            return false;
         }
         var _loc5_:PlaneMaterialCellColumn = new PlaneMaterialCellColumn(param2,param3,param4);
         var _loc6_:PlaneMaterialCellColumn = this.var_318[param1] as PlaneMaterialCellColumn;
         if(_loc6_ != null)
         {
            _loc6_.dispose();
         }
         this.var_318[param1] = _loc5_;
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(this.isStatic)
         {
            if(this.var_30 != null)
            {
               if(this.var_30.width == param2 && this.var_30.height == param3 && Vector3d.isEqual(this.var_690,param4))
               {
                  if(param1 != null)
                  {
         ...
         var _loc8_:* = [];
         var _loc9_:int = 0;
         while(_loc9_ < this.var_318.length)
         {
            _loc11_ = this.var_318[_loc9_] as PlaneMaterialCellColumn;
            if(_loc11_ != null)
            {
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(this.var_1649 == const_110)
         {
            _loc5_ = new Rectangle(0,0,this.var_30.width,this.var_571);
         }
         else
         {
            _loc5_ = new Rectangle(0,this.var_30.height - this.var_571,this.var_30.width,this.var_571);
         }
      ...
      private function renderRepeatBorders(param1:BitmapData, param2:Array) : int
      {
         ...
         if(this.var_318.length == 1)
         {
            _loc4_ = this.var_318[0] as BitmapData;
            if(_loc4_ != null)
            {
               _loc6_ = _loc4_.width;
               _loc5_.push(_loc4_);
