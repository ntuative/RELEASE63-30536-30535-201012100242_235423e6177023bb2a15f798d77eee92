package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class Plane
   {
      ...
      private var var_1022:PlaneVisualization = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_311 != null)
         {
            ...
            {
               _loc1_ = this.var_311.getWithIndex(_loc2_) as PlaneVisualization;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc2_ = this.var_311.getWithIndex(_loc1_) as PlaneVisualization;
            if(_loc2_ != null)
            {
               _loc2_.clearCache();
            }
      ...
      {
         if(this.var_311.getValue(String(param1)) != null)
         {
            return null;
         }
         var _loc5_:PlaneVisualization = new PlaneVisualization(param1,param2,param3,param4);
         this.var_311.add(String(param1),_loc5_);
      ...
      protected function getPlaneVisualization(param1:int) : PlaneVisualization
      {
         ...
         {
            this.var_1022 = this.var_311.getValue(String(this._sizes[_loc2_])) as PlaneVisualization;
         }
         else
         {
            this.var_1022 = null;
