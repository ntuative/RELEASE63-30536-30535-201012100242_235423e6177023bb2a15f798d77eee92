package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1797:int = 16777216;
      ...
      private var var_1469:int = 16777216;
      
      private var var_2620:int = 69069;
      
      private var var_2619:int = 5;
      ...
      {
         var _loc1_:int = this.var_2620 * this.var_1468 + this.var_2619;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1469;
         this.var_1468 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1469 * param2);
      }
   }
}
