package com.sulake.habbo.room.object
{
   ...
   public class RoomPlaneParser
   {
      ...
      private var var_1040:Number = 0.0;
      ...
      public function setTileHeight(param1:int, param2:int, param3:Number) : Boolean
      {
         ...
         if(param1 >= 0 && param1 < this._width && param2 >= 0 && param2 < this._height)
         {
            ...
            {
               if(param1 == this.var_460 || param1 == this.var_458)
               {
                  _loc5_ = false;
                  _loc6_ = this.var_459;
               ...
               if(param2 == this.var_459 || param2 == this.var_461)
               {
                  _loc7_ = false;
                  _loc8_ = this.var_460;
      ...
      public function initializeFromTileData(param1:Boolean = false) : Boolean
      {
         ...
         this.var_885 = getFloorHeight(this.var_138);
         if(!param1)
         {
      ...
      private function createWallPlanes() : Boolean
      {
         ...
         var _loc10_:Array = [this.method_10,this.extractRightWall,this.extractBottomWall,this.extractLeftWall];
         var _loc11_:int = 0;
      ...
      private function method_10(param1:Point) : Point
      {
         if(param1 == null)
         {
            return null;
      ...
      {
         var _loc11_:* = null;
         this.addPlane(RoomPlaneData.const_143,param1,param2,param3,[param4]);
         this.addPlane(RoomPlaneData.const_303,param1,param2,param3,[param4]);
         var _loc9_:Vector3d = Vector3d.crossProduct(param2,param3);
         var _loc10_:Vector3d = Vector3d.product(_loc9_,1 / _loc9_.length * -this.var_1040);
         this.addPlane(RoomPlaneData.const_143,Vector3d.sum(param1,param3),param2,_loc10_,[_loc9_,param4]);
         if(param5)
         {
            this.addPlane(RoomPlaneData.const_143,Vector3d.sum(Vector3d.sum(param1,param2),param3),Vector3d.product(param3,-(param3.length + this.var_118) / param3.length),_loc10_,[_loc9_,param4]);
         }
         if(param6)
         {
            this.addPlane(RoomPlaneData.const_143,Vector3d.sum(param1,Vector3d.product(param3,-this.var_118 / param3.length)),Vector3d.product(param3,(param3.length + this.var_118) / param3.length),_loc10_,[_loc9_,param4]);
            if(param7)
            {
               _loc11_ = Vector3d.product(param2,this.var_1040 / param2.length);
               this.addPlane(RoomPlaneData.const_143,Vector3d.sum(Vector3d.sum(param1,param3),Vector3d.product(_loc11_,-1)),_loc11_,_loc10_,[_loc9_,param2,param4]);
            }
         }
      }
      ...
      {
         var _loc12_:RoomPlaneData = this.addPlane(RoomPlaneData.const_164,param1,param2,param3);
         ...
         if(_loc12_)
         {
            ...
            if(param6)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_164,_loc13_,new Vector3d(0,0,-this.var_118),param2);
               if(_loc14_ != null)
               {
                  if(param8 > 0)
                  {
            ...
            if(param7)
            {
               ...
               _loc14_ = this.addPlane(RoomPlaneData.const_164,_loc13_,new Vector3d(0,0,-this.var_118),Vector3d.product(param2,-1));
               if(_loc14_ != null)
               {
                  if(param9 > 0)
                  {
            ...
            if(param4)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_164,_loc13_,new Vector3d(0,0,-this.var_118),Vector3d.product(param3,-1));
               if(_loc15_ != null)
               {
                  if(param11 > 0)
                  {
            ...
            if(param5)
            {
               ...
               _loc15_ = this.addPlane(RoomPlaneData.const_164,_loc13_,new Vector3d(0,0,-this.var_118),param3);
               if(_loc15_ != null)
               {
                  if(param10 > 0)
                  {
      ...
      public function getPlaneType(param1:int) : int
      {
         if(param1 < 0 || param1 >= this.planeCount)
         {
            return RoomPlaneData.const_1091;
         }
         var _loc2_:RoomPlaneData = this.var_119[param1] as RoomPlaneData;
         if(_loc2_ != null)
         {
