package com.sulake.habbo.communication.messages.incoming.quest
{
   ...
   public class QuestMessageData
   {
      ...
      public function QuestMessageData(param1:IMessageDataWrapper)
      {
         ...
         while(_loc3_ > 0 && this.method_8(this._localizationCode.charAt(_loc3_)))
         {
         ...
         if(_loc3_ > 0)
         {
            this.var_1422 = this._localizationCode.substring(0,_loc3_ + 1);
         }
         else
         {
            this.var_1422 = this._localizationCode;
         }
         this.var_1898 = uint(_loc2_);
      }
