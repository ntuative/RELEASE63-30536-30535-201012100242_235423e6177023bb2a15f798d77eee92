package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1468:uint = 2;
       
      
      private var var_1184:IProtocolEncoder;
      
      private var var_944:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1184 = new WedgieEncoder();
         this.var_944 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            if(_loc5_ == const_1490)
            {
               _loc4_.position = 0;
               _loc6_ = this.var_944.getID(_loc4_);
