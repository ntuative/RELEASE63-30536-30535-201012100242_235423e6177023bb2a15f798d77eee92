package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_524:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_152.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_132,HabboWindowStyle.const_37,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1536,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1536,"/");
         ...
         {
            dispatchEvent(new Event(const_524));
         }
      }
      ...
      private function initSSOTicket() : void
      {
         ...
         {
            this.var_153.removeEventListener(SSOTicket.const_358,this.onParsedTicketSuccess);
            this.var_153.removeEventListener(SSOTicket.const_262,this.method_2);
            this.var_153 = null;
         }
         var _loc1_:String = "";
         ...
         this.var_153 = new SSOTicket(this.var_152.assets,_loc2_,_loc1_);
         this.var_153.addEventListener(SSOTicket.const_358,this.onParsedTicketSuccess);
         this.var_153.addEventListener(SSOTicket.const_262,this.method_2);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_153.ticket);
         this.var_152.shockwaveClientUrl = this.var_153.shockwaveClientUrl;
         this.var_152.ssoTicket = this.var_153.ticket;
         this.var_153.removeEventListener(SSOTicket.const_358,this.onParsedTicketSuccess);
         this.var_153.removeEventListener(SSOTicket.const_262,this.method_2);
         this.var_153 = null;
         dispatchEvent(new Event(const_524));
