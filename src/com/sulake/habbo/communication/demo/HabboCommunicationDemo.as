package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private const const_1536:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_605 = param1;
            this.var_47.initConnection(HabboConnectionType.const_232);
         }
      }
      ...
      {
         if(this.var_47 && this.var_125 && this.var_18 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_605 = this.var_125.getKey("sso.ticket",null);
         this.var_1788 = this.var_125.getKey("flash.client.url","");
         this.var_2498 = this.var_125.getKey("external.variables.txt","");
         if(this.var_209 == null)
         {
            this.var_209 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_524,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_47.mode = HabboConnectionType.const_966;
            }
         }
         this.var_47.initConnection(HabboConnectionType.const_232);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_703);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(this.var_47.mode)
         {
            case HabboConnectionType.const_113:
               ...
               this.var_1379 = _loc4_;
               this.var_209.loadBannerImage(_loc7_ + "?token=" + this.var_1379,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_966:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1456:
               this.var_903 = this.generateRandomHexString(30);
               this.var_491 = new DiffieHellman(new BigInteger(this.var_125.getKey("connection.development.prime"),16),new BigInteger(this.var_125.getKey("connection.development.generator"),16));
               this.var_491.init(this.var_903);
               _loc8_ = this.var_491.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_491.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_491.getSharedKey(16).toUpperCase();
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1788,this.var_2498));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1536,"/");
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2500)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1379);
         ...
         this.var_491 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_491.init(_loc14_);
            _loc15_ = this.var_491.getPublicKey(10);
