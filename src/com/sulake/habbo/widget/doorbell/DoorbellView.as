   ...
   public class DoorbellView
   {
      ...
      public function update() : void
      {
         ...
         if(this.var_51 != null)
         {
            ...
            {
               this.var_51.addListItem(this.createListItem(this.var_313.users[_loc1_] as String,_loc1_));
               _loc1_++;
            }
         }
      }
      ...
      public function createMainWindow() : void
      {
         ...
         this._frame = (this.var_313.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._frame == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
