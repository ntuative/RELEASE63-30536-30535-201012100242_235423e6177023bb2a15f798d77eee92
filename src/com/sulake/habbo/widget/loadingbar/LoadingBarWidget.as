package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_492:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_492.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_492 = null;
         }
         if(this.var_39 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_298,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_298,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_492 == null)
         {
            this.var_492 = new Sprite();
            this.var_492.addChild(new Bitmap(this.var_39));
            this.var_492.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_492.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_39;
            }
         }
         _loc2_.setDisplayObject(this.var_492);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_298)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1166 != "")
         {
            HabboWebTools.openWebPage(this.var_1166);
         }
      }
   }
}
