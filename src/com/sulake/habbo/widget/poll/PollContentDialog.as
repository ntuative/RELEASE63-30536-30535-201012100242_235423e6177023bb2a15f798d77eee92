package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1045;
         if(this.var_1045 < this.var_844.length)
         {
            _loc1_ = this.var_844[this.var_1045] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(this._window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",this.var_844.length);
                  _loc2_.text = _loc6_;
               }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_844[this.var_1045] as Dictionary;
