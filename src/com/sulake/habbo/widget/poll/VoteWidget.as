package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1205:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1205 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_118,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_122,this.showVoteResult);
         param1.addEventListener(RoomWidgetFrameUpdateEvent.const_314,this.update);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_118,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_122,this.showVoteResult);
         param1.removeEventListener(RoomWidgetFrameUpdateEvent.const_314,this.update);
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc4_ = Number(param1) / this.var_1205;
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1205 - param1) / 1000,0);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - this.var_1981;
         if(_loc2_ > this.var_1205)
         {
            this.vote();
            return;
         }
