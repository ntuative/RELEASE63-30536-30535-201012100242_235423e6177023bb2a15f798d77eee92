package com.sulake.habbo.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      private var var_975:PollWidget;
      ...
      {
         this.hideOffer();
         this.var_227 = new PollOfferDialog(this._id,param1,this.var_975);
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         ...
         this.var_227 = new PollContentDialog(this._id,param1,param3,this.var_975);
      }
      ...
      {
         this.var_975.windowManager.alert("${poll_thanks_title}",this.var_1687,0,function(param1:IAlertDialog, param2:Event):void
         {
            param1.dispose();
         });
      }
