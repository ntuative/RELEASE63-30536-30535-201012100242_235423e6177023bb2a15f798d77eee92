package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_985:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_986 = 0;
         this.var_985 = param2.rectangle.clone();
         this.var_985.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_985.width)
         {
            return false;
         }
         if(this.var_986 + param1.height > this.var_985.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_985.width)
         {
            this._offsetX = 0;
            this.var_986 += param1.height + this.const_1815;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_986);
         this._offsetX += param1.width + this.const_1814;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1230 != null && this.var_1230.indexOf(param1) != -1)
         {
