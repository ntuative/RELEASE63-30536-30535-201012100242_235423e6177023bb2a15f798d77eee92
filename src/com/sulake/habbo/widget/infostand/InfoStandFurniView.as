package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_902 = this.var_202.findChildByTag("catalog");
         if(this.var_902 != null)
         {
            this.var_902.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_50.addListItem(this.var_902);
            }
            this.var_902.visible = param1;
         }
         else
         {
            this.var_50.removeListItem(this.var_902);
         }
      }
   }
}
