package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1841:int = 158;
      
      private const const_1842:int = 16;
      
      private const const_1844:uint = 11184810;
      
      private const const_1840:uint = 6710886;
      
      private const const_1843:uint = 3355443;
      
      private const const_1846:String = "level";
      
      private const const_1845:String = "experience";
      
      private const const_1847:String = "energy";
      
      private const const_1848:String = "nutrition";
      ...
      {
         if(this.var_50 == null || this.var_202 == null || this.var_63 == null)
         {
            return;
         }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1846,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1845,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1847,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1848,param1.nutrition,param1.nutritionMax);
         ...
         this.var_1376.remove(param1.id);
         this.var_1376.add(param1.id,param1);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1841,this.const_1842,false);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this.var_1376.getValue(this.var_537) as InfoStandPetData;
         if(_loc1_ != null)
         {
