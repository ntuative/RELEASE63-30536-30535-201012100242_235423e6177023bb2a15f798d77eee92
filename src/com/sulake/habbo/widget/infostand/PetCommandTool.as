package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private const const_1813:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_355 = new Timer(this.const_1813);
         this.var_355.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = this.var_978.getValue(param1) as Array;
         if(_loc6_ == null)
         {
      ...
      {
         var _loc2_:Array = this.var_978.getValue(this.var_537) as Array;
      ...
      {
         this.var_978.remove(param1);
         this.var_978.add(param1,param2);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_41.setParamFlag(WindowParam.const_89,true);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_354 == null)
         {
            ...
            this.var_354 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_354 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_354.x = 200;
            this.var_354.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_320,this.var_537));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_575,this.var_537,this.var_2006 + " " + _loc6_);
