package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_846:int = 150;
      
      private static const const_847:int = 250;
      ...
      private var var_2132:BitmapData;
      
      private var var_2134:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_35 = param3;
         this.var_2130 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1563 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2131 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1564 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1565 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2135 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2132 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_68 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_289,HabboWindowStyle.const_34,HabboWindowParam.const_57,new Rectangle(0,0,param3.width,param3.height - const_76),null,0,0) as IBitmapWrapperWindow;
         ...
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_706,HabboWindowStyle.const_37,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_76),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_474:
               this.var_68.blend += param1 / const_847;
               ...
               break;
            case const_834:
               this.var_68.blend -= param1 / const_846;
               this._window.blend -= param1 / const_846;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_35.width - this.var_2134;
         }
         if(this.var_68 != null)
         {
            this.var_68.rectangle = this.var_35.rectangle;
            this.var_68.height -= const_76;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2133 == this._window.width)
         {
            return;
         }
         this.var_2133 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2131;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1564;
            _loc2_.disposesBitmap = false;
            this.var_2134 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2130,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1563,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1563,_loc9_);
         ...
         this.var_68.bitmap = this.var_2132;
