package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_841:MeMenuSoundSettingsSlider;
      
      private var var_1628:BitmapData;
      
      private var var_1626:BitmapData;
      ...
      {
         this.var_435 = param1.volume;
         if(this.var_841 != null)
         {
            this.var_841.setValue(this.var_435);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            this.var_1628 = (_loc5_.content as BitmapData).clone();
         }
         _loc5_ = this._widget.assets.getAssetByName("sounds_off_white") as BitmapDataAsset;
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1626 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1627 = (_loc5_.content as BitmapData).clone();
         }
         this.var_841 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_638));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_435 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1628);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1626);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_435 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1625);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1627);
         }
      }
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_689);
         }
         else
         {
