package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuClothesView implements IMeMenuView
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_769));
         }
         this._widget = null;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetAvatarEditorMessage(RoomWidgetAvatarEditorMessage.const_330,this._window));
      }
