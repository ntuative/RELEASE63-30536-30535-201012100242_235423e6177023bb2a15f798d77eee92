package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1556:int = 0;
      
      private const const_1557:int = 1;
      
      private const const_1555:int = 2;
      
      private const const_1558:int = 3;
      
      private const const_1826:int = 0;
      
      private const const_1827:int = 1;
      
      private const const_1825:int = 2;
      
      private const const_1829:String = "xmas10_dialog_bg_png";
      
      private const const_1559:String = "xmas10_dialog_telepair_png";
      
      private const const_1205:String = "xmas10_present_dialog_img_png";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_777,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_730,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_523:
               ...
               this.var_1313 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_730:
               ...
               this.var_1313 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_777:
               _loc2_ = this.const_1557;
               this.var_322 = param1.objectId;
               this.var_1313 = param1.data;
         ...
         if(this.var_1312 != _loc2_ && this._window)
         {
      ...
      override public function get mainWindow() : IWindow
      {
         ...
         if(!this._window)
         {
            switch(this.var_1312)
            {
               ...
               case this.const_1557:
                  ...
                  else if(this._status == this.const_1827)
                  {
                     ...
                     _loc2_ = this.const_1559;
                  }
                  else if(this._status == this.const_1825)
                  {
            ...
            if(_loc4_)
            {
               _loc3_ = (assets.getAssetByName(this.const_1829) as BitmapDataAsset).content as BitmapData;
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_644);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         HabboWebTools.facebookViralGiftPost(_loc2_,_loc3_,this.var_1313);
         this.hideInterface();
      }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_564,"ViralGift",param1,param2,param3);
