package com.sulake.habbo.widget.furniture.credit
{
   ...
   public class CreditFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetCreditFurniUpdateEvent.const_640,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetCreditFurniUpdateEvent.const_640,this.onObjectUpdate);
      }
      
      private function onObjectUpdate(param1:RoomWidgetCreditFurniUpdateEvent) : void
      {
         this.hideInterface();
         this.var_932 = param1.objectId;
         this.var_1419 = param1.creditValue;
         this.showInterface();
      }
      ...
      private function showInterface() : void
      {
         ...
         windowManager.registerLocalizationParameter("widgets.furniture.credit.redeem.value","value",String(this.var_1419));
         ...
         this._window = windowManager.createWindow("creditfurniui_container","",HabboWindowType.const_55,HabboWindowStyle.const_34,0 | 0,new Rectangle(const_1134,const_1135,2,2),null,0) as IWindowContainer;
      ...
      private function sendRedeemMessage() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetCreditFurniRedeemMessage(RoomWidgetCreditFurniRedeemMessage.const_782,this.var_932);
