package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1220:Array = new Array(7665141,21495,15161822,15353138,15923281,8581961,0);
      
      private static const const_1221:Array = new Array(int(76.5),int(76.5));
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_565,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_604,this.onHide);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_565,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_604,this.onHide);
      ...
      private function onPresets(param1:RoomWidgetDimmerUpdateEvent) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         this.var_1074 = param1.selectedPresetId - 1;
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_2092 = param1.presetId;
         this.var_1075 = param1.effectId;
         this._color = param1.color;
         this.var_1073 = param1.brightness;
         if(this._view != null)
         {
            this._view.update();
         }
         if(!this.validateBrightness(this.var_1073,this.var_1075))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1073,this.var_1075 == 2);
      ...
      public function storeCurrentSetting(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.var_1074 + 1;
         ...
         var _loc6_:DimmerFurniWidgetPresetItem = this._presets[this.var_1074] as DimmerFurniWidgetPresetItem;
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1073,this.var_1075 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
