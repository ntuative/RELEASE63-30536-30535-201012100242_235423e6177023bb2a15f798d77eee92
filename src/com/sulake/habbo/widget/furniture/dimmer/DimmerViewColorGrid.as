package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerViewColorGrid
   {
      ...
      public function setSelectedColorIndex(param1:int) : void
      {
         ...
         if(param1 < 0 || param1 >= this.var_470.numGridItems)
         {
            return;
         }
         this.select(this.var_470.getGridItemAt(param1) as IWindowContainer);
      }
      
      private function populate(param1:IHabboWindowManager) : void
      {
         if(this._view == null || this.var_470 == null)
         {
            return;
         }
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         this.var_470.destroyGridItems();
         this.var_327 = null;
         for each(_loc2_ in this.colors)
         {
            _loc3_ = param1.buildFromXML(this.var_1697) as IWindowContainer;
            ...
            this.var_470.addGridItem(_loc3_);
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1063.width,this.var_1063.height,true,0);
            ...
            if(_loc6_ != null)
            {
               _loc6_.bitmap = new BitmapData(this.var_863.width,this.var_863.height,true,16777215);
               _loc6_.bitmap.copyPixels(this.var_863,this.var_863.rect,new Point(0,0),null,null,true);
      ...
      {
         var _loc2_:int = this.var_470.getGridItemIndex(param1.target as IWindow);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_1697 = XML(_loc2_.content);
         ...
         this.var_863 = BitmapData(_loc3_.content);
      }
