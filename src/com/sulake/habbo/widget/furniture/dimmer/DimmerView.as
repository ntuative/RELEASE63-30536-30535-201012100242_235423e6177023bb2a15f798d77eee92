package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_363:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_55,HabboWindowStyle.const_34,0 | 0,new Rectangle(const_1134,const_1135,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_552 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_363 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1246 = _loc2_.light;
         if(this.var_363 != null)
         {
            this.var_363.setValue(this.var_1246);
         }
         this.var_430 = this.colors.indexOf(_loc2_.color);
         if(this.var_552 != null)
         {
            this.var_552.setSelectedColorIndex(this.var_430);
         }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1245 = XML(_loc1_.content);
         return this.var_1245;
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_363 != null)
         {
            this.var_363.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_552 != null)
         {
            this.var_552.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
