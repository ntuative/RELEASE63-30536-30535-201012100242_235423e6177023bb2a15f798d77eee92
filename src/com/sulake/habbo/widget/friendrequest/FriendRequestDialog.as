package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestDialog
   {
      ...
      public function set targetRect(param1:Rectangle) : void
      {
         ...
         if(!param1)
         {
            this._widget.ignoreRequest(this.var_1065);
            return;
         }
         if(this.var_1702 || this.var_1703)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               ...
               {
                  case "accept_button":
                     this._widget.acceptRequest(this.var_1065);
                     break;
                  case "decline_button":
                     this._widget.declineRequest(this.var_1065);
                     break;
                  case "close_button":
                     this._widget.ignoreRequest(this.var_1065);
               }
