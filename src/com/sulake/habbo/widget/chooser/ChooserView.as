package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_1579:uint = 0;
      
      private const const_1849:uint = 4.282169599E9;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_1579) : uint(this.const_1578);
      ...
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_919)
         {
            return;
         }
         if(this.var_919 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_919) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_919 % 2) ? uint(this.const_1579) : uint(this.const_1578);
            }
         }
         _loc2_ = this._itemList.getListItemAt(param1) as IWindowContainer;
         if(_loc2_ != null)
         {
            _loc2_.color = this.const_1849;
            this.var_919 = param1;
         }
      }
      ...
      public function removeItem(param1:int, param2:int) : void
      {
         ...
         this.populate(this._items,this.var_1828);
      }
