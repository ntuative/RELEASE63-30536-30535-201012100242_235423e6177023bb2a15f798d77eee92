package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_840:uint = 11;
      ...
      private var var_977:IHabboWindowManager;
      ...
      private var var_534:FramerateTracker = null;
      
      private var var_229:LatencyTracker = null;
      
      private var var_535:LagWarningLogger = null;
      
      private var var_536:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_534 = new FramerateTracker();
         this.var_229 = new LatencyTracker();
         this.var_535 = new LagWarningLogger();
         this.var_536 = new ToolbarClickTracker(this);
         this.var_1223 = new Array(const_840);
         var _loc4_:int = 0;
         while(_loc4_ < const_840)
         {
            this.var_1223[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1390,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1412,Capabilities.serverString);
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_977)
            {
               this.var_977.release(new IIDHabboWindowManager());
               this.var_977 = null;
            }
            if(this.var_263)
            {
            ...
            if(this.var_177)
            {
               ...
               {
                  Component(this.var_177).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
                  Component(this.var_177).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
                  Component(this.var_177).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
                  Component(this.var_177).events.removeEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
                  Component(this.var_177).events.removeEventListener(HabboFriendListTrackingEvent.const_379,this.onFriendlistTrackingEvent);
               }
               this.var_177.release(new IIDHabboFriendList());
               this.var_177 = null;
            }
            if(this.var_171)
            {
      ...
      {
         this.var_1223[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_154 = IHabboConfigurationManager(param2);
         if(this.var_154)
         {
            if(this.var_229 != null)
            {
               this.var_229.configuration = this.var_154;
            }
            if(this.var_230 != null)
            {
               this.var_230.configuration = this.var_154;
            }
            ...
            if(this.var_154)
            {
               ...
               {
                  this.var_535.configure(this.var_154);
               }
               if(this.var_534 != null)
               {
                  this.var_534.configure(this.var_154);
               }
               if(this.var_536 != null)
               {
                  this.var_536.configure(this.var_154);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_153);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_703,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_450,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_535 != null)
            {
               this.var_535.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1323);
         }
         else if(param1.type == HabboHotelViewEvent.const_450)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1471);
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1424);
               break;
            case HabboCommunicationEvent.const_703:
               this.trackLoginStep(HabboLoginTrackingStep.const_1481,String(this._communication.port));
               break;
      ...
      {
         this.var_977 = IHabboWindowManager(param2);
         if(this.var_977)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_154)
            {
               if(this.var_154.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_154.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1223)
                  {
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1055);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1055,this.onCoreRunning);
         }
      }
      ...
      {
         this.var_177 = param2 as IHabboFriendList;
         Component(this.var_177).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_CLOSED,this.onFriendlistTrackingEvent);
         Component(this.var_177).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS,this.onFriendlistTrackingEvent);
         Component(this.var_177).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_SEARCH,this.onFriendlistTrackingEvent);
         Component(this.var_177).events.addEventListener(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST,this.onFriendlistTrackingEvent);
         Component(this.var_177).events.addEventListener(HabboFriendListTrackingEvent.const_379,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_379:
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_260,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_263 = param2 as IAdManager;
         this.var_263.events.addEventListener(AdEvent.const_507,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_536)
         {
            this.var_536.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_154 != null && !Boolean(this.var_154.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_535.chatLagDetected();
      }
      
      public function update(param1:uint) : void
      {
         var _loc2_:int = getTimer();
         if(this.var_976 > -1 && _loc2_ < this.var_976)
         {
            ++this.var_1496;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1496);
         }
         if(this.var_976 > -1 && _loc2_ - this.var_976 > 15000)
         {
            ++this.var_1495;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1495);
         }
         this.var_976 = _loc2_;
         if(this.var_230 != null)
         {
         ...
         if(this.var_534 != null)
         {
            this.var_534.trackUpdate(param1,this);
         }
         if(this.var_535 != null)
         {
            this.var_535.update();
