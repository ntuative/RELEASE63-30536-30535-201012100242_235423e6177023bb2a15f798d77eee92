package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      {
         this.var_210 = IFrameWindow(this.var_69.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_210.findChildByName("description").caption = this.var_69.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_210.findChildByName("reward.currency.desc").caption = this.var_69.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
