package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_2187:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_104.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_2187 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_104)
         {
            this.var_69.controller.activateQuest(this.var_104);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc33_:* = null;
         var _loc34_:* = null;
         var _loc1_:String = ["quest",this.var_69.id,this.var_104.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_69.id,"type_" + this.var_104.type.toLowerCase()].join(".");
         ...
         {
            _loc32_ = this.var_69.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_104.roomItemTypeName);
            if(_loc32_)
            {
               _loc33_ = this.var_69.controller.questEngine.roomEngine.getFurnitureImage(_loc32_.id,new Vector3d(90,0,0),64,this,"");
               this.var_1591 = _loc33_.id;
         ...
         {
            case QuestStatusEnum.const_484:
            ...
            case QuestStatusEnum.const_40:
               ...
               break;
            case QuestStatusEnum.const_161:
               this.setText("quest.status","quest.expired");
               _loc16_.visible = true;
               _loc18_ = 4290822336;
               break;
            case QuestStatusEnum.const_634:
         ...
         this.var_69.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_104.rewardCurrencyAmount.toString());
         ...
         var _loc31_:String = "icon_" + this.var_69.id + "_reward_" + this.var_104.rewardCurrencyAmount;
