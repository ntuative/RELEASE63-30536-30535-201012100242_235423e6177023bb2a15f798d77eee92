   ...
   public class IncomingMessages
   {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(this._questEngine.toolbar != null && this._questEngine.configuration != null)
         {
            ...
            {
               this._questEngine.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_102,HabboToolbarIconEnum.QUESTS));
            }
         }
      }
      ...
      private function onRoomExit(param1:IMessageEvent) : void
      {
         ...
         this._questEngine.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.QUESTS));
      }
