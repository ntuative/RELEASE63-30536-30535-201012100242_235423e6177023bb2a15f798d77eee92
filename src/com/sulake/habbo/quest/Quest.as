package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1494:Date;
      
      private var _localizationCode:String;
      
      private var var_175:Boolean = false;
      
      private var var_2003:uint = 2;
      
      private var var_2002:uint = 0;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1424 = param1.roomItemTypeName;
         this.var_1423 = param1.rewardCurrencyAmount;
         this.var_1494 = new Date();
         this.var_1494.setTime(param1.endDateTimeStamp);
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_175)
            {
               this.var_789.style = this.var_2002;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_175)
            {
               this.var_789.style = this.var_2003;
            }
         }
      }
