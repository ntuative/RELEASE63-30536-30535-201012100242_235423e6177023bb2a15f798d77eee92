package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      private const const_1563:String = "badge_";
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = this.const_1563 + param1;
         ...
         switch(param2)
         {
            case const_1347:
               ...
               {
                  _loc5_ = this.var_154.getKey("image.library.url","http://images.habbo.com/c_images/");
            ...
            case const_1018:
               if(this.var_154 != null)
               {
                  if(this.var_154 != null)
                  {
                     _loc5_ = this.var_154.getKey("group.badge.url");
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(this.const_1563,"");
