   ...
   public class GroupDetailsView
   {
      ...
      private function showGroupInfoDialog(param1:int) : void
      {
         ...
         if(this.var_137 == null)
         {
            ...
            if(_loc3_ != null)
            {
               this.var_137 = this._sessionManager.windowManager.createWindow("habbo_group_details_window","${group.window.title}",HabboWindowType.const_132,HabboWindowStyle.const_34,0 | 0,new Rectangle(10,10,300,220),null) as IWindowContainer;
      ...
      private function onGroupDetailsEvents(param1:Event) : void
      {
         ...
         var _loc3_:HabboGroupDetails = this._sessionManager.getGroupDetails(this.var_2234);
         switch(_loc2_.name)
         {
