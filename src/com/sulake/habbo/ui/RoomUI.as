package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, IUpdateReceiver
   {
      ...
      private var var_994:IRoomWidgetFactory;
      ...
      private var var_1525:IHabboAvatarEditor = null;
      ...
      private var var_993:IHabboHelp;
      
      private var var_803:IHabboModeration;
      ...
      private var var_995:IHabboUserDefinedRoomEvents;
      
      public function RoomUI(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_1242 = RoomDesktop.const_462;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_994.release(new IIDHabboRoomWidget());
            this.var_994 = null;
         }
         ...
         {
            this.var_993.release(new IIDHabboHelp());
            this.var_993 = null;
         }
         ...
         {
            this.var_803.release(new IIDHabboModeration());
            this.var_803 = null;
         }
         ...
         if(this.var_995)
         {
            this.var_995.release(new IIDHabboUserDefinedRoomEvents());
            this.var_995 = null;
         }
         this.var_1525 = null;
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_994 = param2 as IRoomWidgetFactory;
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1525 = param2 as IHabboAvatarEditor;
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         {
            this.var_263.events.addEventListener(AdEvent.const_394,this.adEventHandler);
            this.var_263.events.addEventListener(AdEvent.const_437,this.adEventHandler);
            this.var_263.events.addEventListener(AdEvent.const_507,this.adEventHandler);
         }
      }
      ...
      private function onHabboHelpReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_993 = param2 as IHabboHelp;
      }
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_803 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + this.var_803);
      }
      ...
      private function registerSessionEvents() : void
      {
         if(this.var_18)
         {
            this.var_18.events.addEventListener(RoomSessionEvent.const_216,this.roomSessionStateEventHandler);
            ...
            this.var_18.events.addEventListener(RoomSessionChatEvent.const_174,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionChatEvent.const_542,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionUserBadgesEvent.const_138,this.roomSessionEventHandler);
            ...
            this.var_18.events.addEventListener(RoomSessionPresentEvent.const_283,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionViralFurniStatusEvent.const_452,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionViralFurniStatusEvent.const_525,this.roomSessionEventHandler);
            ...
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_786,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_925,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_1000,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_226,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_253,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_221,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_203,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_229,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_228,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_201,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_739,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_754,this.roomSessionDialogEventHandler);
            ...
            this.var_18.events.addEventListener(RoomSessionErrorMessageEvent.const_759,this.roomSessionDialogEventHandler);
            this.var_18.events.addEventListener(RoomSessionQueueEvent.const_498,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionVoteEvent.const_118,this.roomSessionEventHandler);
            this.var_18.events.addEventListener(RoomSessionVoteEvent.const_122,this.roomSessionEventHandler);
            ...
            this.var_18.events.addEventListener(RoomSessionDimmerPresetsEvent.const_455,this.roomSessionEventHandler);
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_92:
               if(param1.session != null)
               {
                  ...
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.ZOOM));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.MEMENU));
                  this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_144,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      {
         this.var_995 = param2 as IHabboUserDefinedRoomEvents;
      }
      ...
      private function initializeRoomEngineEvents() : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_711,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_643,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_743,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_400,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineEvent.const_464,this.roomEngineEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.const_60,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_675,this.roomEventHandler);
            this._roomEngine.events.addEventListener(RoomEngineObjectEvent.const_597,this.roomObjectEventHandler);
      ...
      private function roomEngineEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         if(param1.type == RoomEngineEvent.const_711)
         {
            if(this.var_18 != null)
            {
               this.var_18.roomEngineReady = true;
         ...
         else if(param1.type == RoomEngineEvent.const_464 || param1.type == RoomEngineEvent.const_400)
         {
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_643:
               ...
               if(this.var_1242 != RoomDesktop.const_462)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_279,this.var_1242);
               }
               if(this.var_263 != null)
               {
               ...
               break;
            case RoomEngineEvent.const_743:
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = this.var_994;
         ...
         _loc3_.avatarEditor = this.var_1525;
         _loc3_.catalog = this._catalog;
         _loc3_.adManager = this.var_263;
         _loc3_.localization = this._localization;
         _loc3_.habboHelp = this.var_993;
         _loc3_.moderation = this.var_803;
         _loc3_.config = this._config;
         _loc3_.soundManager = this.var_592;
         _loc3_.habboTracking = this._habboTracking;
         _loc3_.userDefinedRoomEvents = this.var_995;
