package com.sulake.habbo.ui
{
   ...
   public class FurnitureStickieWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_741,RoomWidgetStickieSendUpdateMessage.const_704,RoomWidgetStickieSendUpdateMessage.const_541];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_741:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc6_ != null)
                  {
                     ...
                     _loc11_ = new RoomWidgetStickieDataUpdateEvent(RoomWidgetStickieDataUpdateEvent.const_573,_loc2_.id,_loc3_.getType(),_loc9_,_loc8_,_loc10_);
