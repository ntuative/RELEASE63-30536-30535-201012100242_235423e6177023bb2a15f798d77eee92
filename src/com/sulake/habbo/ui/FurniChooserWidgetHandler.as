   ...
   public class FurniChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         while(_loc4_ < _loc9_)
         {
            ...
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_378);
         ...
         this._container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_787,_loc3_,this._container.sessionDataManager.isAnyRoomController));
      }
