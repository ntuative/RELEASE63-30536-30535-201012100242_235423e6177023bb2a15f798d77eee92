package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_784,RoomWidgetEcotronBoxOpenMessage.const_778,RoomWidgetEcotronBoxOpenedMessage.const_1374];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_784:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_778:
