package com.sulake.habbo.ui
{
   ...
   public class FurnitureTrophyWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_722];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_722:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     _loc10_ = new RoomWidgetTrophyDataUpdateEvent(RoomWidgetTrophyDataUpdateEvent.const_721,_loc5_,_loc7_,_loc8_,_loc9_);
