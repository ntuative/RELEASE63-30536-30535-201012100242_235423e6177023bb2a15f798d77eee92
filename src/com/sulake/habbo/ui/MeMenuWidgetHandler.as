   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_577,this.onFigureUpdate);
            }
         ...
         {
            this._container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_577,this.onFigureUpdate);
         ...
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_1009,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1056,this.onHabboClubSubscriptionChanged);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1397)
            {
               ...
               this.var_1397 = _loc3_;
               this.var_1820 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1820;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1026,HabboToolbarIconEnum.MEMENU);
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_798);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_713);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_744);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_748);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_663);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_605);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_680);
         _loc1_.push(RoomWidgetStopEffectMessage.const_817);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1445);
         ...
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1505);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1078);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_789);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_584);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_638);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1420);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_689);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_637);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_769);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_584:
            ...
            case RoomWidgetWaveMessage.const_818:
               ...
               break;
            case RoomWidgetDanceMessage.const_798:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetGetEffectsMessage.const_713:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_744:
               if(this._inventory != null)
               {
            ...
            case RoomWidgetOpenCatalogMessage.const_680:
               ...
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_958)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_186,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_605:
               ...
               if(this._inventory != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1071:
                        this._catalog.openCatalogPage(CatalogPageName.const_1503,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1060:
            ...
            case RoomWidgetStopEffectMessage.const_817:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_1096:
               _loc4_ = param1 as RoomWidgetSetToolbarIconMessage;
               switch(_loc4_.widgetType)
               {
                  case RoomWidgetSetToolbarIconMessage.const_1453:
                     break;
                  default:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1095:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_789:
               if(this._container != null)
               {
            ...
            case RoomWidgetAvatarEditorMessage.const_330:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_638:
               ...
               break;
            case RoomWidgetStoreSettingsMessage.const_689:
            ...
            case RoomWidgetStoreSettingsMessage.const_637:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_337,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_769:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_440));
               }
               break;
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case HabboHelpTutorialEvent.const_503:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_415));
         }
      }
