package com.sulake.habbo.ui
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            if(this._container.roomSessionManager != null)
            {
               ...
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_154,this.onPetInfo);
         ...
         if(this._container.roomSessionManager != null)
         {
            ...
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_154,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_732.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_732.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_608);
         _loc1_.push(RoomWidgetFurniActionMessage.const_710);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_701);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_658);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1428);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_320 || param1.type == RoomWidgetUserActionMessage.const_434 || param1.type == RoomWidgetUserActionMessage.const_402)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_691:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1001,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_734:
               this._container.sessionDataManager.method_7(_loc3_.name);
               break;
            ...
            case RoomWidgetUserActionMessage.const_402:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_608:
            ...
            case RoomWidgetFurniActionMessage.const_270:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_710:
            ...
            case RoomWidgetUserActionMessage.const_320:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_701:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_658:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_378);
               ...
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_913);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_920)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_477);
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_247)
               {
                  _loc13_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_227)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_616);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1285;
                  if(!_loc25_)
                  {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_138];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_138:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_732.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_47);
            this.var_732.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_616);
