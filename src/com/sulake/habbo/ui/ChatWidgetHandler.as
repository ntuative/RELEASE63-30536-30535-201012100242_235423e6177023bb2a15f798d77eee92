   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_356 != null)
         {
            ...
            {
               _loc2_ = this.var_356.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_357 != null)
         {
            ...
            {
               _loc2_ = this.var_357.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_763,RoomWidgetChatSelectAvatarMessage.const_803];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_763:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_803:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_357.getValue(_loc16_) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_356.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_794.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_250)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_357.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_356.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_794.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_981 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_981);
            }
            if(this.var_656 == null)
            {
               ...
               this.var_436.y = 0;
               this.var_436.z = 0;
               this.var_656 = _loc4_.getScreenPoint(this.var_436);
               this.var_981 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_436.x = 0;
