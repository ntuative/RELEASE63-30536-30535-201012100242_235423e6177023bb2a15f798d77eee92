package com.sulake.habbo.ui
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_767,RoomWidgetViralFurniMessage.const_644,RoomWidgetViralFurniMessage.const_150];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_767:
               ...
               break;
            case RoomWidgetViralFurniMessage.const_644:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_452,RoomSessionViralFurniStatusEvent.const_525];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_452:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_777);
            ...
            case RoomSessionViralFurniStatusEvent.const_525:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_730);
               _loc3_.status = _loc2_.status;
               _loc3_.data = _loc2_.shareId;
               _loc3_.firstClickUserName = _loc2_.firstClickUserName;
               this._container.events.dispatchEvent(_loc3_);
