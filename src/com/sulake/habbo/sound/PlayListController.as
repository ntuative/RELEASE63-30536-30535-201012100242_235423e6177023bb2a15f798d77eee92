package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1838:String = "type_sound_machine";
      
      private const const_1573:String = "type_jukebox";
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_785,this.onSoundMachinePlayEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_648,this.onSoundMachineStopEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_775,this.onJukeboxInitEvent);
         this.var_87.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_527,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_87)
            {
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_785,this.onSoundMachinePlayEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_648,this.onSoundMachineStopEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_775,this.onJukeboxInitEvent);
               this.var_87.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_527,this.onDisposeEvent);
               this.var_87 = null;
            }
            if(this.var_393)
            {
      ...
      {
         this.startPlaying(this.const_1838);
      }
      ...
      {
         this.startPlaying(this.const_1573);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_280 = _loc2_.id;
            this.playSong(this.var_280);
         }
      }
      
      public function checkSongPlayState(param1:int) : void
      {
         if(this.var_280 == param1)
         {
            this.playSong(this.var_280);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_393[this.var_280] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_393.getValue(this.var_280) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         ...
         if(_loc5_ != null && _loc5_.id != this.var_280)
         {
      ...
      {
         if(this.var_1737 == this.const_1573)
         {
            this.var_74.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_595 = this.var_595.splice(this.var_595.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
