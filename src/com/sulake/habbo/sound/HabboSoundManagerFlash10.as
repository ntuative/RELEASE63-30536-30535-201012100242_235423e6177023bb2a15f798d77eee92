package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_792:TraxSequencer;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_970,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_790.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               ...
               case HabboSoundTypesEnum.const_918:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1465:
            ...
            this.var_790.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_435;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_154.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_154.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_539.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_655.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_655,events);
         _loc8_.volume = this.var_435;
         this.var_792 = null;
         this.var_654 = -1;
         if(_loc5_.length != 0)
         {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_791.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_791 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_154 == null || this._connection == null || this._roomEngine == null || this.var_538 != null)
         {
            return;
         }
      ...
      private function onSampleLoadComplete(param1:Event) : void
      {
         ...
         var _loc3_:int = this.var_539.getValue(_loc2_);
         ...
         this.var_539.remove(_loc2_);
         this.var_655.add(_loc3_,_loc6_);
         if(this.var_539.length == 0 && this.var_654 != -1)
         {
            this.var_792.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_970,this.var_654));
            this.var_654 = -1;
            this.var_792 = null;
         }
      }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1254,this.var_654));
         this.var_654 = -1;
         this.var_792 = null;
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            this.setHabboToolbarIconState(this.var_435 > 0);
            return;
         }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_435 * 100)));
         }
      }
      ...
      {
         this.var_435 = param1;
         this.var_538.updateVolume(this.var_435);
