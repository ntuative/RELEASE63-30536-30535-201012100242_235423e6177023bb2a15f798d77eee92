package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample
   {
      ...
      private static const const_830:int = 32;
       
      
      private var var_1178:Vector.<Number> = null;
      ...
      public function TraxSample(param1:ByteArray, param2:int)
      {
         ...
         this.var_1178 = new Vector.<Number>(_loc3_,true);
         param1.position = 0;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
            ...
            param1.readFloat();
            if(_loc4_ >= _loc3_ - 1 - const_830)
            {
               _loc5_ *= (_loc3_ - _loc4_ - 1) / Number(const_830);
            }
            this.var_1178[_loc4_] = _loc5_;
            _loc4_++;
         }
      }
