package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_570:RoomInfoViewCtrl;
      
      private var var_1048:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_351:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2677:Dictionary;
      ...
      private var var_2263:RoomThumbnailRenderer;
      
      private var var_839:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_275 = new MainViewCtrl(this);
         this.var_570 = new RoomInfoViewCtrl(this);
         this.var_1048 = new RoomCreateViewCtrl(this);
         this.var_2263 = new RoomThumbnailRenderer(this);
         this.var_839 = new GuestRoomPasswordInput(this);
         this.var_313 = new GuestRoomDoorbell(this);
         this.var_351 = new Tabs(this);
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_570.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_102,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_102,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_154.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_275.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_275.startSearch(Tabs.const_244,Tabs.const_381,param1);
         this.var_275.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_275.startSearch(Tabs.const_274,Tabs.const_258);
         this.var_351.getTab(Tabs.const_274).tabPageDecorator.tabSelected();
      }
