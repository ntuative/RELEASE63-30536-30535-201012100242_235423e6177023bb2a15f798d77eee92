package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private var var_904:PublicRoomShortData;
      ...
      public function onRoomEnter(param1:RoomEntryInfoMessageParser) : void
      {
         ...
         {
            this.var_904 = param1.publicSpace;
            this.var_606 = null;
         }
      }
      ...
      public function set categories(param1:Array) : void
      {
         ...
         this.var_1381 = new Array();
         for each(_loc2_ in this.var_1282)
         {
            if(_loc2_.visible)
            {
      ...
      {
         var _loc2_:int = 0;
         this.var_2513 = param1.limit;
         this.var_1382 = param1.favouriteRoomIds.length;
         this._favouriteIds = new Dictionary();
      ...
      {
         return this.var_1382 >= this.var_2513;
      }
