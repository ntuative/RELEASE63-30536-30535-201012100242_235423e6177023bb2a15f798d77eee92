package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2167:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1577 = IButtonWindow(this.find("bg_tab"));
         this.var_1576 = IButtonWindow(this.find("top_tab"));
         this.var_1578 = IButtonWindow(this.find("obj_tab"));
         this.var_2167 = IWindowContainer(this.find("tile_grid"));
         this.var_2168 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1577,this.onBgTabButton);
         Util.setProcDirectly(this.var_1576,this.onTopTabButton);
         Util.setProcDirectly(this.var_1578,this.onObjTabButton);
      }
      ...
      {
         this.setEnabled(this.var_1577,this.var_62.mode != ThumbnailEditorModel.const_35);
         this.setEnabled(this.var_1576,this.var_62.mode != ThumbnailEditorModel.const_54);
         this.setEnabled(this.var_1578,this.var_62.mode != ThumbnailEditorModel.const_33);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2168;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2167;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_410)
            {
