package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      public static const const_410:int = 10;
      
      private static const const_866:int = 32;
      
      private static const const_1207:int = 8;
      
      private static const const_1206:int = -16;
      
      private static const const_1208:int = 40;
      ...
      private function initScreenLocsByPositions() : void
      {
         ...
         this.var_2288 = _loc1_;
      }
      
      private function getLoc(param1:int, param2:int) : Point
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_866 / 2);
         return new Point(param1 * const_866 + _loc3_,param2 * const_1207);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_856.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_856.getImage(ThumbnailEditorModel.const_35,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_856.getImage(ThumbnailEditorModel.const_54,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_856.getImage(ThumbnailEditorModel.const_33,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1206,_loc4_.y + const_1208 - _loc5_.height),null,null,true);
      }
      
      public function getScreenLocForPos(param1:int) : Point
      {
         return Point(this.var_2288[param1]);
      }
   }
}
