package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1031:ICheckBoxWindow;
      
      private var var_1034:ICheckBoxWindow;
      
      private var var_568:ICheckBoxWindow;
      ...
      {
         this.var_314 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_314));
         if(this.var_1029 != null)
         {
            this.var_1029.visible = false;
         }
      }
      
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         if(param1.roomId != this.var_314)
         {
            return;
         }
         this.var_73 = param1;
      ...
      {
         if(param1 != this.var_314 || this.var_1033 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         {
            this.var_681.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1296)
         {
            this.var_681.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1398)
         {
            this.var_1030.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1462)
         {
            ...
            this.setTagError(this.var_840,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1387)
         {
            ...
            this.setTagError(this.var_840,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1504)
         {
            this.var_839.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_681.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_635,this.onDoorModePasswordUnselect);
         ...
         this.var_681 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1030 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_838 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_840 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_839 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1036 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1028 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1031 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1034 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_568 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1615 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1285 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1032 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1035 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1614 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1284 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_236 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1029 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_2216 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2215 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1616 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1616.procedure = this.onSwitchView;
         this.var_1029.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1615.visible = this._inRoom;
         this.var_1614.visible = this._inRoom;
         this.var_2215.visible = this.var_456;
         this.var_2216.visible = !this.var_456;
         if(this.var_456)
         {
            this.var_1035.visible = true;
            this.var_1284.visible = false;
            this.refreshFlatControllers();
            this.var_1035.height = Util.getLowestPoint(this.var_1035) + 4;
         }
         else
         {
            this.populateForm();
            ...
            this.var_1285.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1285.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1032.height = Util.getLowestPoint(this.var_1032) + 4;
         }
         this.var_1616.text = !!this.var_456 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1615.name,this.var_1285.name,this.var_1032.name,this.var_1035.name,this.var_1284.name,this.var_1614.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_681.setText(_loc1_.name);
         this.var_1030.setText(_loc1_.description);
         this.var_839.setText("");
         this.var_1036.setText("");
         ...
         this.setTag(this.var_840,_loc1_.tags[1]);
         if(this.var_1028)
         {
            if(_loc1_.method_1)
            {
         ...
         if(this.var_1031)
         {
            ...
            {
               this.var_1031.select();
            }
            else
            {
               this.var_1031.unselect();
            }
         }
         if(this.var_1034)
         {
         ...
         if(this.var_568)
         {
            ...
            {
               this.var_568.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_568.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_681.getText();
         _loc2_.description = this.var_1030.getText();
         ...
         {
            _loc8_ = this.var_839.getText();
            _loc9_ = this.var_1036.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_839.clearErrors();
               this.var_1036.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.method_1 = this.var_1028.isSelected;
         _loc2_.allowFoodConsume = this.var_1031.isSelected;
         _loc2_.allowWalkThrough = this.var_1034.isSelected;
         _loc2_.hideWalls = this.var_568.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_838,_loc2_.tags);
         this.addTag(this.var_840,_loc2_.tags);
         this.clearErrors();
         this.var_1033 = _loc2_.roomId;
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_314);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_73.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_314]);
         _loc2_.show();
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_314));
      }
