package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1003:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_555 = new Timer(100);
         this.var_555.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
      ...
      public function dispose() : void
      {
         if(this.var_555)
         {
            this.var_555.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_555.reset();
            this.var_555 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1003.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1567 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1567 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_159 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_51 = IItemListWindow(this.var_159.findChildByName("item_list"));
         ...
         var _loc1_:IWindow = this.var_159.findChildByTag("close");
         _loc1_.procedure = this.onCancelButtonClick;
         this.var_1004 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_159.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc2_:Rectangle = Util.getLocationRelativeTo(this.var_159.desktop,this.var_159.width,this.var_159.height);
         this.var_159.x = _loc2_.x;
         this.var_159.y = _loc2_.y;
      }
      
      public function refresh() : void
      {
         this.var_1004.goBackToInitialState();
         this.var_1004.input.textBackgroundColor = 4294967295;
         this.var_1003 = this.var_37[0];
         this.refreshRoomThumbnails();
      ...
      {
         var _loc1_:Boolean = this.var_1004.checkMandatory(this._navigator.getText("navigator.createroom.nameerr"));
         return Boolean(_loc1_);
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_159.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_159.findChildByName("back_button"));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_1004.getText();
         var _loc4_:String = "model_" + this.var_1003.name;
