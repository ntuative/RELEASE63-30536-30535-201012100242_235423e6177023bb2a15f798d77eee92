package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_102,HabboToolbarIconEnum.ROOMINFO));
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_162 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      private function onUserFlatCats(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:RoomsTabPageDecorator = RoomsTabPageDecorator(this._navigator.tabs.getTab(Tabs.const_257).tabPageDecorator);
      ...
      private function onCantConnect(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_.reason)
         {
            case CantConnectMessageParser.const_1315:
               ...
               _loc3_.show();
               break;
            case CantConnectMessageParser.const_1411:
