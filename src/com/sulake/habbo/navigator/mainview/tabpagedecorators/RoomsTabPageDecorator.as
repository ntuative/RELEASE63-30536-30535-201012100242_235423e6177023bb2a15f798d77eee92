package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_302:IDropMenuWindow;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_302 = IDropMenuWindow(_loc3_.findChildByName("roomCtgFilter"));
      ...
      public function prepareRoomCategories() : void
      {
         ...
         this.var_302.procedure = null;
         this.var_302.populate(_loc1_);
         this.var_302.selection = 0;
         this.var_302.procedure = this.onChangeFilter;
      }
      ...
      private function startSearch() : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:int = this.var_302 == null ? 0 : int(this.var_302.selection);
         Logger.log("Room filter changed: " + _loc1_);
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_257,Tabs.const_369);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_257,Tabs.const_598);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_257,Tabs.const_369,"" + _loc3_);
         }
      }
   }
}
