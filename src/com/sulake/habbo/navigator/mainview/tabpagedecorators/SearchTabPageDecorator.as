package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1713:TextSearchInputs;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_1713 == null)
         {
            ...
            this.var_1713 = new TextSearchInputs(this._navigator,false,_loc4_);
         ...
         {
            this.var_1713.searchStr.setText(this._navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      private function onClearResultsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.mainViewCtrl.startSearch(Tabs.const_244,Tabs.const_254,"-1",MainViewCtrl.const_613);
      }
