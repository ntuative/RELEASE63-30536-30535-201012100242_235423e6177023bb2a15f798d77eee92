package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_504:IScrollbarWindow;
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_504 = IScrollbarWindow(this.var_159.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_504.scrollV = 0;
         }
         this.var_159.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_162,null,0);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(this.var_463.visible && this.var_2255)
            {
               return;
            }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1297.tags[0];
            this.var_1297.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2256 - _loc2_.stageX);
         this.var_2256 = _loc2_.stageX;
         this.var_2255 = _loc3_ > 2;
      }
   }
}
