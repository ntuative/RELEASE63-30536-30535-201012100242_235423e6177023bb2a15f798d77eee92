package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_400)
         {
            this.var_400.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_400.reset();
            this.var_400 = null;
         }
         if(this.var_339)
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_49 == null)
         {
            this.var_49 = IWindowContainer(this._navigator.getXmlWindow(this.var_1204));
         ...
         this.var_49.x = _loc2_.x + this.var_2192 + param1.width;
