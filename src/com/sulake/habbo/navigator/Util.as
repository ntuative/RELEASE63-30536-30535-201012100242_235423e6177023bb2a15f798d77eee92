package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1327:CutToWidth = new CutToWidth();
      
      private static var var_1328:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1328.beforeSearch(param2,param1,param3);
         binarySearch(var_1328,param2.length - 1);
      }
