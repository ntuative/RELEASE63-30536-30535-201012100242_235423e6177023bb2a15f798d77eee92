package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2263 = new RoomThumbnailRenderer(param1);
         this.var_1104 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_169,this.var_111);
         if(this.var_111.ownerName != "" && this.var_111.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_169,!!this.var_111.event ? this.getEventCtg(this.var_111.categoryId) : this.getRoomCtg(this.var_111.categoryId));
         this.refreshRoomDesc(this.var_169,this.var_111);
         this.refreshExtraCont();
         this.refreshInfo(this.var_169,"trading_allowed",this.var_111.allowTrading);
         this.refreshInfo(this.var_169,"doormode_doorbell",this.var_111.doorMode == 1);
         this.refreshInfo(this.var_169,"doormode_password",this.var_111.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_169,this.var_111.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1104.refreshTags(_loc1_,this.var_111.tags);
         ...
         this.var_2263.refreshThumbnail(_loc1_,this.var_111.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_244,Tabs.const_254,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
