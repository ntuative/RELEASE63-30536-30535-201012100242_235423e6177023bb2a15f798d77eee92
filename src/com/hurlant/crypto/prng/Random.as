   ...
   public class Random
   {
      ...
      public function Random(param1:Class = null)
      {
         ...
         while(this.var_112 < this.psize)
         {
            ...
            var _loc4_:*;
            this.var_145[_loc4_ = this.var_112++] = _loc2_ & 255;
         }
         this.var_112 = 0;
         this.seed();
      }
      ...
      public function seed(param1:int = 0) : void
      {
         ...
         var _loc4_:*;
         this.var_145[_loc4_ = this.var_112++] = this.var_145[_loc4_] ^ param1 >> 16 & 255;
         var _loc5_:*;
         this.var_145[_loc5_ = this.var_112++] = this.var_145[_loc5_] ^ param1 >> 24 & 255;
