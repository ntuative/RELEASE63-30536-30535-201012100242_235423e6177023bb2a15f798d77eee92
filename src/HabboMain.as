package
{
   ...
   public class HabboMain extends Sprite
   {
      ...
      private static const const_822:Number = 0.71;
      ...
      private var var_1172:HabboTracking;
      ...
      private function prepareCore() : void
      {
         ...
         this.var_1172 = HabboTracking.getInstance();
      ...
      private function configLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         {
            Habbo.reportCrash("Failed to download external configuration document " + _loc2_.assetLoader.url + "!",Core.const_269,null);
         }
      }
      ...
      private function setupCoreConfigFromLoader(param1:AssetLoaderStruct) : void
      {
         ...
         {
            Habbo.reportCrash("Download external configuration document is null!",Core.const_269,null);
         }
         if(this.var_23)
         {
         ...
         {
            Habbo.reportCrash("Core vanished while downloading config document!",Core.const_269,null);
         }
      }
      ...
      private function onProgressEvent(param1:ProgressEvent) : void
      {
         ...
         if(this.var_1)
         {
            ...
            if(param1 is LibraryProgressEvent)
            {
               ...
               {
                  if(this.var_1172 && !this.var_1172.disposed)
                  {
                     this.var_1172.track("libraryLoaded",_loc4_.fileName,_loc4_.elapsedTime);
                  }
               }
            }
         }
      ...
      private function updateLoadingBar(param1:DisplayObjectContainer, param2:Number) : void
      {
         ...
         var _loc12_:Number = 1 - const_822 + this.var_23.getNumberOfFilesLoaded() / _loc11_ * const_822;
         _loc8_.x = 1 + 1;
         _loc8_.y = 1 + 1;
